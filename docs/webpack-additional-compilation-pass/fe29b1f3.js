...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "https%3A%2F%2Flihautan.com%2Fwebpack-additional-compilation-pass",
					"name": /*title*/ ctx[0]
				},
				"name": /*title*/ ctx[0],
				"position": 2
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "https%3A%2F%2Flihautan.com%2Fwebpack-additional-compilation-pass");
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw1_value = `<code class="language-css"><span class="token comment">/* filename: http://cdn/assets/style.xxx.css */</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw2_value = `<code class="language-js"><span class="token keyword">import</span> express <span class="token keyword">from</span> <span class="token string">'express'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
app<span class="token punctuation">.</span><span class="token function">listen</span><span class="token punctuation">(</span>process<span class="token punctuation">.</span>env<span class="token punctuation">.</span><span class="token constant">PORT</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw3_value = `<code class="language-js"><span class="token comment">// ...</span>
...
<span class="token comment">// ...</span></code>` + "";
	...
	let raw4_value = `<code class="language-js"><span class="token comment">// ...</span>
...
<span class="token comment">// ...</span></code>` + "";
	...
	let raw5_value = `<code class="language-">dist
...
└── bundle.js  // &lt;-- the main output bundle</code>` + "";
	...
	let raw6_value = `<code class="language-js"><span class="token comment">// ...</span>
...
<span class="token comment">// ...</span></code>` + "";
	...
	let raw7_value = `<code class="language-js"><span class="token comment">// filename: webpack.config.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw8_value = `<code class="language-js"><span class="token comment">// filename: bundle.js</span>
...
<span class="token comment">// ...</span></code>` + "";
	...
	let raw9_value = `<code class="language-">dist
...
└── webpack-manifest.json // &lt;-- relative to bundle.js</code>` + "";
	...
	let raw10_value = `<code class="language-js"><span class="token comment">// filename: bundle.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw12_value = `<code class="language-js"><span class="token comment">// filename: bundle.js</span>
...
<span class="token comment">// ...continue with bundle.js</span></code>` + "";
	...
	let raw13_value = `<code class="language-js"><span class="token operator">-</span> <span class="token function">thisCompliation</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>manifest <span class="token operator">==</span> <span class="token keyword">undefined</span><span class="token punctuation">;</span><span class="token punctuation">)</span>
<span class="token operator">-</span> <span class="token comment">// ...</span>
<span class="token operator">-</span> <span class="token function">emit</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>manifest <span class="token operator">=</span> manifest<span class="token punctuation">)</span> <span class="token comment">// too late!</span></code>` + "";
	...
	let raw14_value = `<code class="language-js"><span class="token keyword">const</span> ManifestPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'webpack-manifest-plugin'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw15_value = `<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyWebpackPlugin</span> <span class="token punctuation">&#123;</span>
  <span class="token function">apply</span><span class="token punctuation">(</span><span class="token parameter">compiler</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    compiler<span class="token punctuation">.</span>hooks<span class="token punctuation">.</span>thisCompilation<span class="token punctuation">.</span><span class="token function">tap</span><span class="token punctuation">(</span><span class="token string">'MyWebpackPlugin'</span><span class="token punctuation">,</span> <span class="token parameter">compilation</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw16_value = `<code class="language-js"><span class="token operator">-</span> <span class="token function">thisCompliation</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>manifest <span class="token operator">==</span> <span class="token keyword">undefined</span><span class="token punctuation">;</span><span class="token punctuation">)</span>
<span class="token operator">-</span> <span class="token comment">// ...</span>
...
<span class="token operator">-</span> <span class="token comment">// ...</span></code>` + "";
	...
	let raw17_value = `<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyWebpackPlugin</span> <span class="token punctuation">&#123;</span>
  <span class="token function">apply</span><span class="token punctuation">(</span><span class="token parameter">compiler</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="prism-highlight-code-line">            parser<span class="token punctuation">.</span>hooks<span class="token punctuation">.</span>expression</span>
<span class="prism-highlight-code-line">              <span class="token punctuation">.</span><span class="token function">for</span><span class="token punctuation">(</span><span class="token string">'CSS_FILES'</span><span class="token punctuation">)</span></span>
<span class="prism-highlight-code-line">              <span class="token punctuation">.</span><span class="token function">tap</span><span class="token punctuation">(</span><span class="token string">'MyWebpackPlugin'</span><span class="token punctuation">,</span> <span class="token parameter">expr</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span></span>
<span class="prism-highlight-code-line">                <span class="token keyword">return</span> ParserHelpers<span class="token punctuation">.</span><span class="token function">toConstantDependency</span><span class="token punctuation">(</span></span>
<span class="prism-highlight-code-line">                  parser<span class="token punctuation">,</span></span>
<span class="prism-highlight-code-line">                  <span class="token constant">JSON</span><span class="token punctuation">.</span><span class="token function">stringify</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>manifest<span class="token punctuation">)</span></span>
<span class="prism-highlight-code-line">                <span class="token punctuation">)</span><span class="token punctuation">(</span>expr<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw18_value = `<code class="language-js"><span class="token comment">// filename: bundle.js</span>
<span class="token comment">// ...</span>
app<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
  <span class="token comment">// ...</span>
  res<span class="token punctuation">.</span><span class="token function">json</span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
    <span class="token comment">// replaced via parser hooks</span>
<span class="prism-highlight-code-line">    css<span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">'http://cdn/assets/style.xxx.css'</span><span class="token punctuation">]</span><span class="token punctuation">,</span></span>
    html<span class="token punctuation">:</span> htmlContent<span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
