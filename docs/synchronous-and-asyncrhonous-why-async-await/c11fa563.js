...
var baseCss = "http://127.0.0.1:8080/synchronous-and-asyncrhonous-why-async-await/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fsynchronous-and-asyncrhonous-why-async-await",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fsynchronous-and-asyncrhonous-why-async-await");
...
/* content/blog/synchronous-and-asyncrhonous-why-async-await/@@page-markup.svelte generated by Svelte v3.24.0 */
...
const metadata = {
	...
	"wip": true,
	"slug": "synchronous-and-asyncrhonous-why-async-await",
	"type": "blog"
};
