...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img4 = claim_element(picture0_nodes, "IMG", { alt: true, src: true });
			...
			img6 = claim_element(picture1_nodes, "IMG", { alt: true, src: true });
			...
			img7 = claim_element(picture2_nodes, "IMG", { alt: true, src: true });
			...
			img8 = claim_element(picture3_nodes, "IMG", { alt: true, src: true });
