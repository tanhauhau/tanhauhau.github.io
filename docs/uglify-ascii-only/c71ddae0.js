...
var baseCss = "http://127.0.0.1:8080/uglify-ascii-only/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fuglify-ascii-only",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fuglify-ascii-only");
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img3 = claim_element(p8_nodes, "IMG", { src: true, alt: true });
			...
			img4 = claim_element(p11_nodes, "IMG", { src: true, alt: true });
			...
			img6 = claim_element(p18_nodes, "IMG", { src: true, alt: true });
