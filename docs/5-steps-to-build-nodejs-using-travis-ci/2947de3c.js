...
var baseCss = "http://127.0.0.1:8080/5-steps-to-build-nodejs-using-travis-ci/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2F5-steps-to-build-nodejs-using-travis-ci",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2F5-steps-to-build-nodejs-using-travis-ci");
...
function create_default_slot(ctx) {
	...
	let raw0_value = `
<code class="language-yml"><span class="token key atrule">language</span><span class="token punctuation">:</span> node_js
<span class="token key atrule">node_js</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token number">4.2</span></code>` + "";
	...
	let raw1_value = `
<code class="language-sh">curl https://gist.githubusercontent.com/tanhauhau/405e39884e80288615a7b51181fd5228/raw/9045c2e219547f0a228da630abff345d8add0c47/.travis.yml &gt; .travis.yml</code>` + "";
...
<span class="token key atrule">before_script</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> bower install</code>` + "";
	...
	let raw3_value = `
<code class="language-sh">curl https://gist.githubusercontent.com/tanhauhau/71998bf221810186f046db94cda10c4e/raw/d1e8aee0981a96c20f94de6db386da048face423/.travis.yml &gt; .travis.yml</code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img0 = claim_element(p5_nodes, "IMG", { src: true, alt: true });
			...
			img1 = claim_element(p9_nodes, "IMG", { src: true, alt: true });
			...
			img2 = claim_element(p21_nodes, "IMG", { src: true, alt: true });
			...
			img3 = claim_element(p25_nodes, "IMG", { src: true, alt: true });
			...
			img4 = claim_element(p30_nodes, "IMG", { src: true, alt: true });
			...
			img5 = claim_element(p34_nodes, "IMG", { src: true, alt: true });
