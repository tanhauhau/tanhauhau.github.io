...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-">pick #2 commit msg 2
pick #3 commit msg 3
pick #4 commit msg 4
pick #5 commit msg 5
pick #6 commit msg 6
...
...</code>` + "";
	...
	let raw1_value = `<code class="language-">pick #2 commit msg 2
pick #3 commit msg 3
pick #4 commit msg 4
pick #5 commit msg 5
pick #6 commit msg 6</code>` + "";
	...
	let raw2_value = `<code class="language-">pick #2 commit msg 2
drop #3 commit msg 3
pick #4 commit msg 4
pick #5 commit msg 5
pick #6 commit msg 6</code>` + "";
	...
	let raw3_value = `<code class="language-">pick   #2 commit msg 2
...
pick   #6 commit msg 6</code>` + "";
	...
	let raw4_value = `<code class="language-">pick   #2 commit msg 2
pick   #3 commit msg 3
break
pick   #4 commit msg 4
pick   #5 commit msg 5
pick   #6 commit msg 6</code>` + "";
	...
	let raw5_value = `<code class="language-">pick   #2 commit msg 2
edit   #3 commit msg 3
pick   #4 commit msg 4
pick   #5 commit msg 5
pick   #6 commit msg 6</code>` + "";
	...
	let raw6_value = `<code class="language-sh">$ <span class="token function">git</span> bisect start <span class="token comment"># starts the bisect session</span>
$ <span class="token function">git</span> bisect bad v2.5.1 <span class="token comment"># specify the commit you know is bad</span>
$ <span class="token function">git</span> bisect good v2.6.13 <span class="token comment"># specify the commit you knew were good</span></code>` + "";
	...
	let t474;
	let pre7;
	let raw7_value = `<code class="language-">Bisecting: 675 revisions left to test after this (roughly 10 steps)</code>` + "";
	let t475;
	let p78;
	let t476;
	let code110;
	...
	let raw8_value = `<code class="language-sh"><span class="token comment"># if it is a good commit</span>
$ <span class="token function">git</span> bisect good

<span class="token comment"># if it is a bad commit</span>
$ <span class="token function">git</span> bisect bad</code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img1 = claim_element(p8_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img2 = claim_element(p11_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img3 = claim_element(p14_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img4 = claim_element(p17_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img5 = claim_element(p20_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img6 = claim_element(p22_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img7 = claim_element(p25_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img8 = claim_element(p27_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img9 = claim_element(p31_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img10 = claim_element(p34_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img11 = claim_element(picture0_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img12 = claim_element(picture1_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img13 = claim_element(picture2_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img14 = claim_element(picture3_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img15 = claim_element(picture4_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img16 = claim_element(picture5_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img17 = claim_element(picture6_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img18 = claim_element(p52_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img19 = claim_element(picture7_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img20 = claim_element(picture8_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img21 = claim_element(picture9_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img22 = claim_element(picture10_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
			...
			img23 = claim_element(picture11_nodes, "IMG", {
				title: true,
				alt: true,
				"data-src": true,
				loading: true
		...
		h() {
			...
			attr(img12, "data-src", __build_img__13);
			...
			attr(img19, "title", "null");
			attr(img19, "alt", "git-rebase-w");
			attr(img19, "data-src", __build_img__19);
			attr(img19, "loading", "lazy");
			...
			attr(img20, "title", "null");
			attr(img20, "alt", "git-rebase-w-2");
			attr(img20, "data-src", __build_img__20);
			attr(img20, "loading", "lazy");
			...
			attr(img21, "title", "null");
			attr(img21, "alt", "git-rebase-w-3");
			attr(img21, "data-src", __build_img__21);
			attr(img21, "loading", "lazy");
			...
			attr(img22, "title", "null");
			attr(img22, "alt", "git-rebase-w-4");
			attr(img22, "data-src", __build_img__22);
			attr(img22, "loading", "lazy");
			...
			attr(img23, "title", "null");
			attr(img23, "alt", "git-rebase-w-5");
			attr(img23, "data-src", __build_img__23);
			attr(img23, "loading", "lazy");
