...
var baseCss = "http://127.0.0.1:8080/understanding-scopes-with-ast/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Funderstanding-scopes-with-ast",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Funderstanding-scopes-with-ast");
...
/* content/blog/understanding-scopes-with-ast/@@page-markup.svelte generated by Svelte v3.24.0 */
...
const metadata = {
	...
	"wip": true,
	"slug": "understanding-scopes-with-ast",
	"type": "blog"
};
