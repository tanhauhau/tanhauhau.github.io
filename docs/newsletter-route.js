...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			main = element("main");
			h1 = element("h1");
			t1 = text("Li Hau's Weekly Learning");
			t2 = space();
			p0 = element("p");
			t3 = text("In this weekly newsletter I'm going to share with you what I've learned in this week in the world of web development, with my notes and thoughts.");
			t4 = space();
			p1 = element("p");
			t5 = text("I won't spam though, I promise.");
			t6 = space();
			p2 = element("p");
			t7 = text("You can also ");
			a0 = element("a");
			t8 = text("view my previous issues");
			t9 = text(" and ");
			a1 = element("a");
			t10 = text("subscribe via RSS");
			t11 = text("!");
			t12 = space();
			div = element("div");
			t13 = space();
		...
		l(nodes) {
			...
			var h1_nodes = children(h1);
			t1 = claim_text(h1_nodes, "Li Hau's Weekly Learning");
			h1_nodes.forEach(detach);
			t2 = claim_space(main_nodes);
			p0 = claim_element(main_nodes, "P", {});
			var p0_nodes = children(p0);
			t3 = claim_text(p0_nodes, "In this weekly newsletter I'm going to share with you what I've learned in this week in the world of web development, with my notes and thoughts.");
			p0_nodes.forEach(detach);
			t4 = claim_space(main_nodes);
			p1 = claim_element(main_nodes, "P", {});
			var p1_nodes = children(p1);
			t5 = claim_text(p1_nodes, "I won't spam though, I promise.");
			p1_nodes.forEach(detach);
			t6 = claim_space(main_nodes);
			p2 = claim_element(main_nodes, "P", {});
			var p2_nodes = children(p2);
			t7 = claim_text(p2_nodes, "You can also ");
			a0 = claim_element(p2_nodes, "A", { href: true });
			var a0_nodes = children(a0);
			t8 = claim_text(a0_nodes, "view my previous issues");
			a0_nodes.forEach(detach);
			t9 = claim_text(p2_nodes, " and ");
			a1 = claim_element(p2_nodes, "A", { href: true });
			var a1_nodes = children(a1);
			t10 = claim_text(a1_nodes, "subscribe via RSS");
			a1_nodes.forEach(detach);
