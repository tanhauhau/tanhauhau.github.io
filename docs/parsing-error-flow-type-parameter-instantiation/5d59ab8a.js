...
function create_default_slot(ctx) {
	...
	let t42;
	let pre1;
	let raw1_value = `<code class="language-js"><span class="token keyword module">export</span> <span class="token keyword">function</span> foobar <span class="token operator">&lt;</span> <span class="token maybe-class-name">XType</span> <span class="token operator">></span> baz<span class="token punctuation">;</span></code>` + "";
	let t43;
	let p6;
	let t44;
	let code5;
	...
	let raw2_value = `<code class="language-js"><span class="token doc-comment comment">/** <span class="token keyword">@module</span> foobar */</span>
...
<span class="token function">foobar</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw5_value = `<code class="language-js"><span class="token doc-comment comment">/** <span class="token keyword">@module</span> */</span>
<span class="token comment">// @flow</span>
<span class="token function">foobar</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
...
<span class="token comment">// @flow</span></code>` + "";
	...
	let raw8_value = `<code class="language-js"><span class="token function">addComment</span><span class="token punctuation">(</span>comment<span class="token punctuation">:</span> <span class="token constant">N</span><span class="token punctuation">.</span><span class="token property-access"><span class="token maybe-class-name">Comment</span></span><span class="token punctuation">)</span><span class="token punctuation">:</span> <span class="token keyword">void</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw9_value = `<code class="language-js">foobar <span class="token operator">&lt;</span> <span class="token maybe-class-name">XType</span> <span class="token operator">></span> <span class="token number">1</span><span class="token punctuation">;</span>
<span class="token comment">// @flow</span>
