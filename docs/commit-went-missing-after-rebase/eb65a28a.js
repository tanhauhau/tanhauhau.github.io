...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-">$ git checkout feat/a
$ git rebase origin/feat/a</code>` + "";
	...
	let t89;
	let pre1;
	let raw1_value = `<code class="language-">$ git rebase origin/feat/a</code>` + "";
	let t90;
	let p17;
	let t91;
	let t92;
	let pre2;
	let raw2_value = `<code class="language-">$ git rebase --onto origin/feat/a origin/feat/a feat/a</code>` + "";
	let t93;
	let ul1;
	let li1;
	let code26;
	...
	let t152;
	let pre3;
	let raw3_value = `<code class="language-">$ git rebase --onto origin/feat/a master feat/a</code>` + "";
	let t153;
	let p28;
	let t154;
	let t155;
