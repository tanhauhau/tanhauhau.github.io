...
var baseCss = "http://127.0.0.1:8080/commit-went-missing-after-rebase/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fcommit-went-missing-after-rebase",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fcommit-went-missing-after-rebase");
...
<code class="language-">$ git rebase --onto origin/feat/a master feat/a</code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img1 = claim_element(p11_nodes, "IMG", { src: true, alt: true, title: true });
			...
			img2 = claim_element(p15_nodes, "IMG", { src: true, alt: true, title: true });
			...
			img3 = claim_element(p19_nodes, "IMG", { src: true, alt: true });
			...
			img4 = claim_element(p21_nodes, "IMG", { src: true, alt: true });
			...
			img5 = claim_element(p25_nodes, "IMG", { src: true, alt: true });
			...
			img6 = claim_element(p27_nodes, "IMG", { src: true, alt: true });
			...
			img7 = claim_element(p29_nodes, "IMG", { src: true, alt: true });
		...
		h() {
			...
			attr(img2, "title", "The 3 reference points");
