...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw1_value = `<code class="language-svelte">&lt;script&gt;
  let name = &#39;world&#39;;
  function update() &#123;
    name = &#39;Svelte&#39;;
  &#125;
...
ctx<span class="token punctuation">.</span><span class="token method function property-access">update</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// logs &#96;world&#96; scoped in the &#96;instance&#96; closure</span></code>` + "";
	...
	let raw3_value = `<code class="language-svelte">&lt;script&gt;
  let agility = 0;
  let power = 0;
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw10_value = `<code class="language-js">obj<span class="token punctuation">.</span><span class="token property-access">c</span> <span class="token operator">=</span> <span class="token string">'hello'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw13_value = `<code class="language-svelte">&lt;script&gt;
...
familyName <span class="token operator">-</span><span class="token operator">></span> <span class="token number">1</span></code>` + "";
	...
	let raw16_value = `<code class="language-js">$$<span class="token punctuation">.</span><span class="token property-access">dirty</span> <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">0b0000_0011</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<span class="token comment">// Now</span>
$$<span class="token punctuation">.</span><span class="token property-access">ctx</span><span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span> <span class="token operator">+</span> $$<span class="token punctuation">.</span><span class="token property-access">ctx</span><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">;</span></code>` + "";
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw25_value = `<code class="language-svelte">&lt;script&gt;
  export let count = 0;
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw29_value = `<code class="language-svelte">&lt;script&gt;
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw31_value = `<code class="language-svelte">&lt;script&gt;
  let givenName = &#39;&#39;, familyName = &#39;&#39;;
  function update() &#123;
    givenName = &#39;Li Hau&#39;;
    familyName = &#39;Tan&#39;;
...
<span class="token comment">// #2 &#96;familyName = 'Tan'</span>
name <span class="token operator">=</span> <span class="token string">'Li Hau'</span> <span class="token operator">+</span> <span class="token string">' '</span> <span class="token operator">+</span> <span class="token string">'Tan'</span><span class="token punctuation">;</span>
<span class="token console class-name">console</span><span class="token punctuation">.</span><span class="token method function property-access">log</span><span class="token punctuation">(</span><span class="token string">'Li Hau Tan'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw33_value = `<code class="language-svelte">&lt;script&gt;
  let givenName = &#39;&#39;, familyName = &#39;&#39;;
  function update() &#123;
    givenName = &#39;Li Hau&#39;;
    familyName = &#39;Tan&#39;;
...
&lt;/script&gt;</code>` + "";
	...
	let raw34_value = `<code class="language-svelte">&lt;script&gt;
  let givenName = &#39;&#39;, familyName = &#39;&#39;;
  function update() &#123;
    givenName = &#39;Li Hau&#39;;
    familyName = &#39;Tan&#39;;
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw36_value = `<code class="language-svelte">&lt;script&gt;
  let count = 0;
  $: doubled = count * 2;
&lt;/script&gt;
