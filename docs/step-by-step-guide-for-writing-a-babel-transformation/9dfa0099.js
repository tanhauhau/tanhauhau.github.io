...
var __build_img_webp__2 = "aa140e7ffe777036.webp";

var __build_img__2 = "aa140e7ffe777036.png";

var __build_img_webp__1 = "1b4b7b8861eb17f0.webp";

var __build_img__1 = "1b4b7b8861eb17f0.png";

var __build_img_webp__0 = "bacd2ed2088b43ce.webp";
...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> parse <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@babel/parser'</span><span class="token punctuation">;</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>output<span class="token punctuation">.</span>code<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'const x = 1;'</span></code>` + "";
	...
	let t75;
	let pre1;
	let raw1_value = `<code class="language-">code -&gt; AST -&gt; transformed AST -&gt; transformed code</code>` + "";
	let t76;
	let p10;
	let t77;
	let code5;
	...
	let raw2_value = `<code class="language-js"><span class="token keyword">import</span> babel <span class="token keyword">from</span> <span class="token string">'@babel/core'</span><span class="token punctuation">;</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>output<span class="token punctuation">.</span>code<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'const x = 1;'</span></code>` + "";
	...
	let raw3_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token string">'Hello '</span> <span class="token operator">+</span> name<span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>

console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">greet</span><span class="token punctuation">(</span><span class="token string">'tanhauhau'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Hello tanhauhau</span></code>` + "";
	...
	let raw4_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">teerg</span><span class="token punctuation">(</span><span class="token parameter">eman</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">teerg</span><span class="token punctuation">(</span><span class="token string">'t'</span> <span class="token operator">+</span> <span class="token string">'a'</span> <span class="token operator">+</span> <span class="token string">'n'</span> <span class="token operator">+</span> <span class="token string">'h'</span> <span class="token operator">+</span> <span class="token string">'a'</span> <span class="token operator">+</span> <span class="token string">'u'</span> <span class="token operator">+</span> <span class="token string">'h'</span> <span class="token operator">+</span> <span class="token string">'a'</span> <span class="token operator">+</span> <span class="token string">'u'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Hello tanhauhau</span></code>` + "";
	...
	let raw5_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">myCustomPlugin</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token punctuation">&#123;</span>
<span class="prism-highlight-code-line">    visitor<span class="token punctuation">:</span> <span class="token punctuation">&#123;</span></span>
<span class="prism-highlight-code-line">      <span class="token function">Identifier</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span></span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw6_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">myCustomPlugin</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token punctuation">&#123;</span>
    visitor<span class="token punctuation">:</span> <span class="token punctuation">&#123;</span>
      <span class="token function">Identifier</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw7_value = `<code class="language-">identifier
identifier
string literal
identifier
identifier
...
string literal</code>` + "";
	...
	let raw8_value = `<code class="language-js"><span class="token function">Identifier</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw9_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">teerg</span><span class="token punctuation">(</span><span class="token parameter">eman</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
elosnoc<span class="token punctuation">.</span><span class="token function">gol</span><span class="token punctuation">(</span><span class="token function">teerg</span><span class="token punctuation">(</span><span class="token string">'tanhauhau'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Hello tanhauhau</span></code>` + "";
	...
	let raw10_value = `<code class="language-js"><span class="token function">Identifier</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw11_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">teerg</span><span class="token punctuation">(</span><span class="token parameter">eman</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token string">'Hello '</span> <span class="token operator">+</span> eman<span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>

console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">teerg</span><span class="token punctuation">(</span><span class="token string">'tanhauhau'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Hello tanhauhau</span></code>` + "";
	...
	let t278;
	let pre12;
	let raw12_value = `<code class="language-js"><span class="token keyword">const</span> log <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span></code>` + "";
	let t279;
	let blockquote3;
	let p45;
	let t280;
	...
	let raw13_value = `<code class="language-js"><span class="token function">StringLiteral</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let t328;
	let pre14;
	let raw14_value = `<code class="language-">RangeError: Maximum call stack size exceeded</code>` + "";
	let t329;
	let p50;
	let t330;
	let t331;
	...
	let raw15_value = `<code class="language-js"><span class="token function">StringLiteral</span><span class="token punctuation">(</span><span class="token parameter">path</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">const</span> newNode <span class="token operator">=</span> path<span class="token punctuation">.</span>node<span class="token punctuation">.</span>value
    <span class="token punctuation">.</span><span class="token function">split</span><span class="token punctuation">(</span><span class="token string">''</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">map</span><span class="token punctuation">(</span><span class="token parameter">c</span> <span class="token operator">=></span> babel<span class="token punctuation">.</span>types<span class="token punctuation">.</span><span class="token function">stringLiteral</span><span class="token punctuation">(</span>c<span class="token punctuation">)</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">reduce</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">prev<span class="token punctuation">,</span> curr</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  path<span class="token punctuation">.</span><span class="token function">replaceWith</span><span class="token punctuation">(</span>newNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="prism-highlight-code-line">  path<span class="token punctuation">.</span><span class="token function">skip</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw16_value = `<code class="language-js"><span class="token keyword">const</span> babel <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'@babel/core'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">const</span> output <span class="token operator">=</span> babel<span class="token punctuation">.</span><span class="token function">transformSync</span><span class="token punctuation">(</span>code<span class="token punctuation">,</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>output<span class="token punctuation">.</span>code<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	return {
		c() {
			...
			t394 = text("Manipulating AST with JavaScript using Babel");
			t395 = space();
			p60 = element("p");
			t396 = text("If you like what you've read so far, and want to learn how you could do it with Babel. I've created a ");
			a51 = element("a");
			t397 = text("video course");
			t398 = text(", showing you step-by-step, how to write a babel plugin and codemod.");
			t399 = space();
			p61 = element("p");
			t400 = text("In the video course, I detailed tips and tricks, such as how to handle scope, how to use state, and also nested traversals.");
			t401 = space();
			p62 = element("p");
			strong3 = element("strong");
			a52 = element("a");
			t402 = text("Sounds interesting, let's take a look at the video course");
			t403 = space();
			...
			li23 = element("li");
			a54 = element("a");
			t406 = text("Babel docs");
			t407 = text(" & ");
			a55 = element("a");
			t408 = text("Github repo");
			t409 = space();
			li24 = element("li");
			a56 = element("a");
			t410 = text("Babel Handbook");
			t411 = text(" by ");
			a57 = element("a");
			t412 = text("Jamie Kyle");
			t413 = space();
			li25 = element("li");
			a58 = element("a");
			t414 = text("Leveling Up One’s Parsing Game With ASTs");
			t415 = text(" by ");
			a59 = element("a");
			t416 = text("Vaidehi Joshi");
			this.h();
		},
		l(nodes) {
			...
			picture0 = claim_element(p19_nodes, "PICTURE", {});
			...
			picture1 = claim_element(p23_nodes, "PICTURE", {});
			...
			picture2 = claim_element(p39_nodes, "PICTURE", {});
			...
			t393 = claim_space(section11_nodes);
			blockquote4 = claim_element(section11_nodes, "BLOCKQUOTE", {});
			var blockquote4_nodes = children(blockquote4);
			p59 = claim_element(blockquote4_nodes, "P", {});
			var p59_nodes = children(p59);
			strong2 = claim_element(p59_nodes, "STRONG", {});
			var strong2_nodes = children(strong2);
			t394 = claim_text(strong2_nodes, "Manipulating AST with JavaScript using Babel");
			strong2_nodes.forEach(detach);
			p59_nodes.forEach(detach);
			t395 = claim_space(blockquote4_nodes);
			p60 = claim_element(blockquote4_nodes, "P", {});
			var p60_nodes = children(p60);
			t396 = claim_text(p60_nodes, "If you like what you've read so far, and want to learn how you could do it with Babel. I've created a ");
			a51 = claim_element(p60_nodes, "A", { href: true, rel: true });
			var a51_nodes = children(a51);
			t397 = claim_text(a51_nodes, "video course");
			a51_nodes.forEach(detach);
			t398 = claim_text(p60_nodes, ", showing you step-by-step, how to write a babel plugin and codemod.");
			p60_nodes.forEach(detach);
			t399 = claim_space(blockquote4_nodes);
			p61 = claim_element(blockquote4_nodes, "P", {});
			var p61_nodes = children(p61);
			t400 = claim_text(p61_nodes, "In the video course, I detailed tips and tricks, such as how to handle scope, how to use state, and also nested traversals.");
			p61_nodes.forEach(detach);
			t401 = claim_space(blockquote4_nodes);
			p62 = claim_element(blockquote4_nodes, "P", {});
			var p62_nodes = children(p62);
			strong3 = claim_element(p62_nodes, "STRONG", {});
			var strong3_nodes = children(strong3);
			a52 = claim_element(strong3_nodes, "A", { href: true, rel: true });
			var a52_nodes = children(a52);
			t402 = claim_text(a52_nodes, "Sounds interesting, let's take a look at the video course");
			a52_nodes.forEach(detach);
			strong3_nodes.forEach(detach);
			p62_nodes.forEach(detach);
			blockquote4_nodes.forEach(detach);
			section11_nodes.forEach(detach);
			t403 = claim_space(nodes);
			section12 = claim_element(nodes, "SECTION", {});
			var section12_nodes = children(section12);
			h24 = claim_element(section12_nodes, "H2", {});
			var h24_nodes = children(h24);
			a53 = claim_element(h24_nodes, "A", { href: true, id: true });
			var a53_nodes = children(a53);
			t404 = claim_text(a53_nodes, "Reference");
			a53_nodes.forEach(detach);
			h24_nodes.forEach(detach);
			t405 = claim_space(section12_nodes);
			ul7 = claim_element(section12_nodes, "UL", {});
			var ul7_nodes = children(ul7);
			li23 = claim_element(ul7_nodes, "LI", {});
			var li23_nodes = children(li23);
			a54 = claim_element(li23_nodes, "A", { href: true, rel: true });
			var a54_nodes = children(a54);
			t406 = claim_text(a54_nodes, "Babel docs");
			a54_nodes.forEach(detach);
			t407 = claim_text(li23_nodes, " & ");
			a55 = claim_element(li23_nodes, "A", { href: true, rel: true });
			var a55_nodes = children(a55);
			t408 = claim_text(a55_nodes, "Github repo");
			a55_nodes.forEach(detach);
			li23_nodes.forEach(detach);
			t409 = claim_space(ul7_nodes);
			li24 = claim_element(ul7_nodes, "LI", {});
			var li24_nodes = children(li24);
			a56 = claim_element(li24_nodes, "A", { href: true, rel: true });
			var a56_nodes = children(a56);
			t410 = claim_text(a56_nodes, "Babel Handbook");
			a56_nodes.forEach(detach);
			t411 = claim_text(li24_nodes, " by ");
			a57 = claim_element(li24_nodes, "A", { href: true, rel: true });
			var a57_nodes = children(a57);
			t412 = claim_text(a57_nodes, "Jamie Kyle");
			a57_nodes.forEach(detach);
			li24_nodes.forEach(detach);
			t413 = claim_space(ul7_nodes);
			li25 = claim_element(ul7_nodes, "LI", {});
			var li25_nodes = children(li25);
			a58 = claim_element(li25_nodes, "A", { href: true, rel: true });
			var a58_nodes = children(a58);
			t414 = claim_text(a58_nodes, "Leveling Up One’s Parsing Game With ASTs");
			a58_nodes.forEach(detach);
			t415 = claim_text(li25_nodes, " by ");
			a59 = claim_element(li25_nodes, "A", { href: true, rel: true });
			var a59_nodes = children(a59);
			t416 = claim_text(a59_nodes, "Vaidehi Joshi");
		...
		h() {
			...
			attr(a51, "href", "https://gum.co/manipulating-ast-with-javascript");
			attr(a51, "rel", "nofollow");
			attr(a52, "href", "https://gum.co/manipulating-ast-with-javascript");
			attr(a52, "rel", "nofollow");
			attr(a53, "href", "#reference");
			attr(a53, "id", "reference");
			attr(a54, "href", "https://babeljs.io/docs/en/");
			attr(a54, "rel", "nofollow");
			attr(a55, "href", "https://github.com/babel/babel");
			attr(a55, "rel", "nofollow");
			attr(a56, "href", "https://github.com/jamiebuilds/babel-handbook");
			attr(a56, "rel", "nofollow");
			attr(a57, "href", "https://jamie.build/");
			attr(a57, "rel", "nofollow");
			attr(a58, "href", "https://medium.com/basecs/leveling-up-ones-parsing-game-with-asts-d7a6fc2400ff");
			attr(a58, "rel", "nofollow");
			attr(a59, "href", "https://twitter.com/vaidehijoshi");
		...
		m(target, anchor) {
			...
			append(a50, t391);
			append(p58, t392);
			append(section11, t393);
			append(section11, blockquote4);
			append(blockquote4, p59);
			append(p59, strong2);
			append(strong2, t394);
			append(blockquote4, t395);
			append(blockquote4, p60);
			append(p60, t396);
			append(p60, a51);
			append(a51, t397);
			append(p60, t398);
			append(blockquote4, t399);
			append(blockquote4, p61);
			append(p61, t400);
			append(blockquote4, t401);
			append(blockquote4, p62);
			append(p62, strong3);
			append(strong3, a52);
			append(a52, t402);
			insert(target, t403, anchor);
			insert(target, section12, anchor);
			append(section12, h24);
			append(h24, a53);
			append(a53, t404);
			append(section12, t405);
