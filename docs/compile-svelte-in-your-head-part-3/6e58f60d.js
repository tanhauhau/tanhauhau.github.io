...
var image = "https://lihautan.com/compile-svelte-in-your-head-part-3/assets/hero-twitter-e9eff02b.jpg";
...
&lt;div use:doSomething /&gt;</code>` + "";
	...
	let raw4_value = `<code class="language-svelte">&lt;script&gt;
  import Draggable from &#39;the-draggable-library&#39;;
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw8_value = `<code class="language-svelte">&lt;div on:click=&#123;event =&gt; &#123;
...
&lt;/div&gt;</code>` + "";
	...
	let t149;
	let pre9;
	let raw9_value = `<code class="language-js">element<span class="token punctuation">.</span><span class="token method function property-access">removeEventListener</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span> handleClick<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	let t150;
	let section9;
	let h34;
	let a36;
...
actionObj<span class="token punctuation">.</span><span class="token method function property-access">destroy</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw12_value = `<code class="language-svelte">&lt;script&gt;
  function onChange() &#123;&#125;
&lt;/script&gt;
...
<span class="token comment">// ...</span></code>` + "";
	...
	let raw14_value = `<code class="language-svelte">&lt;script&gt;
	let i=0;
	function onClick() &#123;
		i++;
	&#125;
...
&lt;input bind:value=&#123;before&#125; on:input=&#123;uppercase&#125; /&gt; &#123;before&#125;</code>` + "";
	...
	let raw22_value = `<code class="language-svelte">&lt;script&gt;
  let before = &#39;&#39;
  let after = &#39;&#39;;
...
&lt;input bind:value=&#123;before&#125; use:uppercase /&gt; &#123;before&#125;</code>` + "";
	...
	let raw23_value = `<code class="language-svelte">&lt;script&gt;
  let checked;
  function onChange() &#123;&#125;
  function action() &#123;&#125;
&lt;/script&gt;
