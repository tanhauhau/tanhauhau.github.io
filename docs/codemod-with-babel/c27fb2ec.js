...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "https%3A%2F%2Flihautan.com%2Fcodemod-with-babel",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "https%3A%2F%2Flihautan.com%2Fcodemod-with-babel");
...
/* content/blog/codemod-with-babel/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	let raw_value = `<code class="language-js"><span class="token keyword">const</span> babel <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'@babel/core'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
      ...
      <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        <span class="token keyword">return</span> <span class="token punctuation">&#123;</span>
          <span class="token function">manipulateOptions</span><span class="token punctuation">(</span><span class="token parameter">opts<span class="token punctuation">,</span> parserOpts</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
            ...
            */</span>
            parserOpts<span class="token punctuation">.</span><span class="token property-access">plugins</span><span class="token punctuation">.</span><span class="token method function property-access">push</span><span class="token punctuation">(</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	return {
		c() {
			p0 = element("p");
			t0 = text("A general template that I used:");
			t1 = space();
			pre = element("pre");
			t2 = space();
			p1 = element("p");
			t3 = text("[Updated on 2019-09-13]");
			t4 = space();
			p2 = element("p");
			t5 = text("I have written a ");
			a = element("a");
			t6 = text("step-by-step guide");
			t7 = text(" on how to write a babel transformation plugin.");
			t8 = space();
			p3 = element("p");
			t9 = text("The only difference in this template than the guide is that there's this ");
			code = element("code");
			t10 = text("manipulateOptions");
			t11 = text(" where you can add additional parser options to enable ES2015+ syntax.");
			this.h();
		},
		l(nodes) {
			p0 = claim_element(nodes, "P", {});
			var p0_nodes = children(p0);
			t0 = claim_text(p0_nodes, "A general template that I used:");
			...
			t3 = claim_text(p1_nodes, "[Updated on 2019-09-13]");
			p1_nodes.forEach(detach);
			t4 = claim_space(nodes);
			p2 = claim_element(nodes, "P", {});
			var p2_nodes = children(p2);
			t5 = claim_text(p2_nodes, "I have written a ");
			a = claim_element(p2_nodes, "A", { href: true });
			var a_nodes = children(a);
			t6 = claim_text(a_nodes, "step-by-step guide");
			a_nodes.forEach(detach);
			t7 = claim_text(p2_nodes, " on how to write a babel transformation plugin.");
			p2_nodes.forEach(detach);
			t8 = claim_space(nodes);
			p3 = claim_element(nodes, "P", {});
			var p3_nodes = children(p3);
			t9 = claim_text(p3_nodes, "The only difference in this template than the guide is that there's this ");
			code = claim_element(p3_nodes, "CODE", {});
			var code_nodes = children(code);
			t10 = claim_text(code_nodes, "manipulateOptions");
			code_nodes.forEach(detach);
			t11 = claim_text(p3_nodes, " where you can add additional parser options to enable ES2015+ syntax.");
			p3_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(pre, "class", "language-js");
			attr(a, "href", "/step-by-step-guide-for-writing-a-babel-transformation");
		},
		m(target, anchor) {
