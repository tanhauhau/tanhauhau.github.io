...
var baseCss = "http://127.0.0.1:8080/12-line-rollup-plugin/assets/_blog-299aa480.css";

var image = "http://127.0.0.1:8080/12-line-rollup-plugin/assets/hero-twitter-2f46c1f3.jpg";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2F12-line-rollup-plugin",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2F12-line-rollup-plugin");
