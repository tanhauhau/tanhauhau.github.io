...
var __build_img_webp__5 = "5d1149492a736853.webp";

var __build_img__5 = "5d1149492a736853.png";

var __build_img_webp__4 = "0dc13f8c069e8acf.webp";

var __build_img__4 = "0dc13f8c069e8acf.png";

var __build_img_webp__3 = "1e9bb055aa2e0df8.webp";

var __build_img__3 = "1e9bb055aa2e0df8.png";

var __build_img_webp__2 = "73374f21676ced2d.webp";

var __build_img__2 = "73374f21676ced2d.png";

var __build_img_webp__1 = "4ace4c13f412987f.webp";

var __build_img__1 = "4ace4c13f412987f.png";

var __build_img_webp__0 = "013a66d17b8bc1b0.webp";

var __build_img__0 = "013a66d17b8bc1b0.png";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "https%3A%2F%2Flihautan.com%2FDebugging%20web%20workers",
					"name": /*title*/ ctx[0]
				},
				"name": /*title*/ ctx[0],
				"position": 2
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "https%3A%2F%2Flihautan.com%2FDebugging%20web%20workers");
...
/* content/blog/Debugging web workers/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			p0 = element("p");
			a3 = element("a");
			t4 = text("Web Workers API");
			t5 = text(" allows you to start a separate worker thread and receives and execute tasks off the main thread.");
			t6 = space();
			p1 = element("p");
			t7 = text("Since worker runs in a separate worker thread, how would you debug, ie set breakpoint, console log, and inspect your worker script?");
			t8 = space();
			p2 = element("p");
			t9 = text("Here's how you would do it for various major browsers:");
			t10 = space();
			...
			t12 = space();
			p3 = element("p");
			t13 = text("If you are debugging service worker or worker, you can head down to the console. There's a dropdown menu, if you haven't noticed previously, that says \"JavaScript context\".");
			t14 = space();
			p4 = element("p");
			...
			t16 = space();
			p6 = element("p");
			t17 = text("For worker context, you would see a cog logo beside the name.");
			t18 = space();
			p7 = element("p");
			t19 = text("After you choose the worker context, you can type ");
			code0 = element("code");
			t20 = text("self");
			t21 = text(" into the console, and you should see ");
			code1 = element("code");
			t22 = text("self");
			t23 = text(" is an instance of ");
			code2 = element("code");
			t24 = text("DedicatedWorkerGlobalScope");
			t25 = text(" instead of ");
			code3 = element("code");
			t26 = text("window");
			t27 = text(".");
			...
			t29 = space();
			p9 = element("p");
			t30 = text("For shared worker, you would need to go to ");
			a5 = element("a");
			t31 = text("chrome://inspect/#workers");
			t32 = text(". Select \"Shared workers\" on the left panel.");
			t33 = space();
			p10 = element("p");
			...
			t34 = space();
			p11 = element("p");
			t35 = text("You would be able to see a list of shared workers if you have any running.");
			t36 = space();
			p12 = element("p");
			t37 = text("You can click \"inspect\", which will open a new console for you to debug.");
			t38 = space();
			...
			t40 = space();
			p13 = element("p");
			t41 = text("For Firefox, you could go to ");
			a7 = element("a");
			t42 = text("about:debugging#workers");
			t43 = text(". You will be able to see a list of service workers, and shared workers registered to the browser.");
			t44 = space();
			p14 = element("p");
			...
			t47 = space();
			p15 = element("p");
			t48 = text("For Safari, you could find the JavaScript context dropdown at the bottom right corner of your console.");
			t49 = space();
			p16 = element("p");
		...
		l(nodes) {
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Firefox");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a3_nodes = children(a3);
			t4 = claim_text(a3_nodes, "Web Workers API");
			a3_nodes.forEach(detach);
			t5 = claim_text(p0_nodes, " allows you to start a separate worker thread and receives and execute tasks off the main thread.");
			p0_nodes.forEach(detach);
			t6 = claim_space(nodes);
			p1 = claim_element(nodes, "P", {});
			var p1_nodes = children(p1);
			t7 = claim_text(p1_nodes, "Since worker runs in a separate worker thread, how would you debug, ie set breakpoint, console log, and inspect your worker script?");
			p1_nodes.forEach(detach);
			t8 = claim_space(nodes);
			p2 = claim_element(nodes, "P", {});
			var p2_nodes = children(p2);
			t9 = claim_text(p2_nodes, "Here's how you would do it for various major browsers:");
			...
			var a4_nodes = children(a4);
			t11 = claim_text(a4_nodes, "Chrome");
			a4_nodes.forEach(detach);
			h20_nodes.forEach(detach);
			t12 = claim_space(section1_nodes);
			p3 = claim_element(section1_nodes, "P", {});
			var p3_nodes = children(p3);
			t13 = claim_text(p3_nodes, "If you are debugging service worker or worker, you can head down to the console. There's a dropdown menu, if you haven't noticed previously, that says \"JavaScript context\".");
			...
			picture1 = claim_element(p5_nodes, "PICTURE", {});
			...
			t17 = claim_text(p6_nodes, "For worker context, you would see a cog logo beside the name.");
			p6_nodes.forEach(detach);
			t18 = claim_space(section1_nodes);
			p7 = claim_element(section1_nodes, "P", {});
			var p7_nodes = children(p7);
			t19 = claim_text(p7_nodes, "After you choose the worker context, you can type ");
			code0 = claim_element(p7_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t20 = claim_text(code0_nodes, "self");
			code0_nodes.forEach(detach);
			t21 = claim_text(p7_nodes, " into the console, and you should see ");
			code1 = claim_element(p7_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t22 = claim_text(code1_nodes, "self");
			code1_nodes.forEach(detach);
			t23 = claim_text(p7_nodes, " is an instance of ");
			code2 = claim_element(p7_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t24 = claim_text(code2_nodes, "DedicatedWorkerGlobalScope");
			code2_nodes.forEach(detach);
			t25 = claim_text(p7_nodes, " instead of ");
			code3 = claim_element(p7_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t26 = claim_text(code3_nodes, "window");
			code3_nodes.forEach(detach);
			t27 = claim_text(p7_nodes, ".");
			p7_nodes.forEach(detach);
			t28 = claim_space(section1_nodes);
			p8 = claim_element(section1_nodes, "P", {});
			var p8_nodes = children(p8);
			picture2 = claim_element(p8_nodes, "PICTURE", {});
			...
			t30 = claim_text(p9_nodes, "For shared worker, you would need to go to ");
			a5 = claim_element(p9_nodes, "A", { href: true });
			var a5_nodes = children(a5);
			t31 = claim_text(a5_nodes, "chrome://inspect/#workers");
			a5_nodes.forEach(detach);
			t32 = claim_text(p9_nodes, ". Select \"Shared workers\" on the left panel.");
			p9_nodes.forEach(detach);
			t33 = claim_space(section1_nodes);
			p10 = claim_element(section1_nodes, "P", {});
			var p10_nodes = children(p10);
			picture3 = claim_element(p10_nodes, "PICTURE", {});
			...
			t35 = claim_text(p11_nodes, "You would be able to see a list of shared workers if you have any running.");
			p11_nodes.forEach(detach);
			t36 = claim_space(section1_nodes);
			p12 = claim_element(section1_nodes, "P", {});
			var p12_nodes = children(p12);
			t37 = claim_text(p12_nodes, "You can click \"inspect\", which will open a new console for you to debug.");
			...
			var a6_nodes = children(a6);
			t39 = claim_text(a6_nodes, "Firefox");
			a6_nodes.forEach(detach);
			h21_nodes.forEach(detach);
			t40 = claim_space(section2_nodes);
			p13 = claim_element(section2_nodes, "P", {});
			var p13_nodes = children(p13);
			t41 = claim_text(p13_nodes, "For Firefox, you could go to ");
			a7 = claim_element(p13_nodes, "A", { href: true });
			var a7_nodes = children(a7);
			t42 = claim_text(a7_nodes, "about:debugging#workers");
			a7_nodes.forEach(detach);
			t43 = claim_text(p13_nodes, ". You will be able to see a list of service workers, and shared workers registered to the browser.");
			p13_nodes.forEach(detach);
			t44 = claim_space(section2_nodes);
			p14 = claim_element(section2_nodes, "P", {});
			var p14_nodes = children(p14);
			picture4 = claim_element(p14_nodes, "PICTURE", {});
			...
			var a8_nodes = children(a8);
			t46 = claim_text(a8_nodes, "Safari");
			a8_nodes.forEach(detach);
			h22_nodes.forEach(detach);
			t47 = claim_space(section3_nodes);
			p15 = claim_element(section3_nodes, "P", {});
			var p15_nodes = children(p15);
			t48 = claim_text(p15_nodes, "For Safari, you could find the JavaScript context dropdown at the bottom right corner of your console.");
		...
		h() {
			attr(a0, "href", "#chrome");
			attr(a1, "href", "#firefox");
			attr(a2, "href", "#safari");
			attr(ul, "class", "sitemap");
			attr(ul, "id", "sitemap");
			attr(ul, "role", "navigation");
			attr(ul, "aria-label", "Table of Contents");
			attr(a3, "href", "https://developer.mozilla.org/en-US/docs/Web/API/Worker");
			...
			attr(img1, "alt", "chrome console context");
			...
			attr(img2, "alt", "chrome worker context");
			attr(img2, "data-src", __build_img__2);
			attr(img2, "loading", "lazy");
			attr(a5, "href", "chrome://inspect/#workers");
			...
			attr(img3, "alt", "chrome shared worker");
			attr(img3, "data-src", __build_img__3);
			attr(img3, "loading", "lazy");
			attr(a6, "href", "#firefox");
			attr(a6, "id", "firefox");
			attr(a7, "href", "about:debugging#workers");
			...
			attr(img4, "alt", "firefox shared worker");
			...
			attr(img5, "alt", "safari console context");
