...
var baseCss = "http://127.0.0.1:8080/retry-async-function-with-callback-promise/assets/_blog-299aa480.css";

var image = "http://127.0.0.1:8080/retry-async-function-with-callback-promise/assets/hero-twitter-3c52317b.jpg";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fretry-async-function-with-callback-promise",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fretry-async-function-with-callback-promise");
...
<span class="token function">getPromiseB</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// a promise</span>
  ...
  <span class="token punctuation">.</span><span class="token method function property-access">catch</span><span class="token punctuation">(</span>handleB<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// returns another new promise</span></code>` + "";
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token console class-name">console</span><span class="token punctuation">.</span><span class="token method function property-access">log</span><span class="token punctuation">(</span><span class="token string">'here'</span><span class="token punctuation">,</span> value<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw21_value = `
<code class="language-js"><span class="token string">"here"</span> <span class="token keyword nil">undefined</span></code>` + "";
	...
	let raw22_value = `
<code class="language-js"><span class="token string">"resolved"</span> <span class="token string">"value"</span></code>` + "";
