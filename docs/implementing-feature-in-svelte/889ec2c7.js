...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-svelte"><span class="token comment">&lt;!-- loop &#96;n&#96; through 1, 2, 3, 4, 5 --></span>
...
<span class="token language-javascript"><span class="token punctuation">&#123;</span><span class="token operator">/</span>range<span class="token punctuation">&#125;</span></span></code>` + "";
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name"><span class="token namespace">bind:</span>value=</span><span class="token language-javascript"><span class="token punctuation">&#123;</span>end<span class="token punctuation">&#125;</span></span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>number<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>` + "";
	...
	let raw2_value = `<code class="language-">ParseError: Expected if, each or await
  ...
  at new Parser (compiler.js:6288:12)</code>` + "";
	...
	let raw3_value = `<code class="language-">Error: Not implemented: RangeBlock
  ...
  at new Element$1 (compiler.js:16523:19)</code>` + "";
	...
	let raw4_value = `<code class="language-">Error: TODO implement RangeBlock
  ...
  at dom (compiler.js:13199:19)</code>` + "";
	...
	let raw5_value = `<code class="language-js"><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">class</span> <span class="token class-name">RangeBlockWrapper</span> <span class="token keyword">extends</span> <span class="token class-name">Wrapper</span> <span class="token punctuation">&#123;</span>
