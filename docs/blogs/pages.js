...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "svelte-18plfh0");
		},
		m(target, anchor) {
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		h() {
			attr(p0, "class", "title svelte-18plfh0");
			attr(a, "href", a_href_value = "/" + /*slug*/ ctx[4]);
			attr(a, "class", "svelte-18plfh0");
			attr(li, "class", "svelte-18plfh0");
			this.first = li;
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "svelte-18plfh0");
			attr(main, "class", "blogs svelte-18plfh0");
		},
		m(target, anchor) {
