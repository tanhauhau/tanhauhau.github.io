...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		h() {
			attr(p0, "class", "title svelte-ydavce");
			attr(a, "href", a_href_value = "/" + /*slug*/ ctx[4]);
			attr(a, "class", "svelte-ydavce");
			attr(li, "class", "svelte-ydavce");
			this.first = li;
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "svelte-ydavce");
			attr(main, "class", "blogs svelte-ydavce");
		},
		m(target, anchor) {
