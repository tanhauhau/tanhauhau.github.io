...
var baseCss = "http://127.0.0.1:8080/eslint-for-flow-explicit-type-argument-syntax/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Feslint-for-flow-explicit-type-argument-syntax",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Feslint-for-flow-explicit-type-argument-syntax");
...
<code class="language-js">fooFunction <span class="token operator">&lt;</span> <span class="token maybe-class-name">Bar</span> <span class="token operator">></span> <span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	return {
		...
		l(nodes) {
			...
			img2 = claim_element(p12_nodes, "IMG", { src: true, alt: true });
			...
			img3 = claim_element(p18_nodes, "IMG", { src: true, alt: true });
