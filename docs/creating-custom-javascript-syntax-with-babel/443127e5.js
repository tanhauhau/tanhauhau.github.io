...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-js"><span class="token comment">// '@@' makes the function &#96;foo&#96; curried</span>
...
<span class="token console class-name">console</span><span class="token punctuation">.</span><span class="token method function property-access">log</span><span class="token punctuation">(</span><span class="token function">foo</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 6</span></code>` + "";
	...
	let raw1_value = `<code class="language-js"><span class="token function">foo</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 6</span>
...
<span class="token function">bar</span><span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 6</span></code>` + "";
	...
	let raw2_value = `<code class="language-sh">$ git clone https://github.com/tanhauhau/babel.git
...
$ make build</code>` + "";
	...
	let raw3_value = `<code class="language-yml"><span class="token punctuation">-</span> doc
...
- test/</code>` + "";
	...
	let raw5_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/test/curry-function.js</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw6_value = `<code class="language-sh">SyntaxError: Unexpected token (1:9)
...
at Parser.parseIdentifier (packages/babel-parser/src/parser/statement.js:1096:52)</code>` + "";
	...
	let t170;
	let pre7;
	let raw7_value = `<code class="language-sh">BABEL_ENV=test node_modules/.bin/jest -u packages/babel-parser/test/curry-function.js</code>` + "";
	let t171;
	let p21;
	let t172;
	let code25;
	...
	let raw8_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/src/parser/expression.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw9_value = `<code class="language-js"><span class="token maybe-class-name">TokenType</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw10_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/src/tokenizer/types.js</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw11_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/src/tokenizer/index.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw12_value = `<code class="language-js"><span class="token comment">// current token</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw13_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/src/parser/statement.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw14_value = `<code class="language-sh"> PASS  packages/babel-parser/test/curry-function.js
...
<code class="language-">(MultiplicativeExpression &quot;*&quot; (AdditiveExpression &quot;+&quot; 1 2) 3)</code>` + "";
	...
	let raw18_value = `<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">Parser</span> <span class="token punctuation">&#123;</span>
  <span class="token comment">// ...</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw19_value = `<code class="language-js"><span class="token comment">// filename: packages/babel-parser/src/parser/statement.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw20_value = `<code class="language-js"><span class="token comment">// filename: babel-plugin-transformation-curry-function.js</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw21_value = `<code class="language-js"><span class="token keyword">function</span> <span class="token function">currying</span><span class="token punctuation">(</span><span class="token parameter">fn</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw22_value = `<code class="language-js"><span class="token comment">// from</span>
<span class="token keyword">function</span> @@ <span class="token function">foo</span><span class="token punctuation">(</span><span class="token parameter">a<span class="token punctuation">,</span> b<span class="token punctuation">,</span> c</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> a <span class="token operator">+</span> b <span class="token operator">+</span> c<span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span></code>` + "";
	...
	let raw23_value = `<code class="language-js"><span class="token comment">// filename: babel-plugin-transformation-curry-function.js</span>
<span class="token keyword module">export</span> <span class="token keyword module">default</span> <span class="token keyword">function</span> <span class="token function">ourBabelPlugin</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token punctuation">&#123;</span>
    <span class="token comment">// ...</span>
    <span class="token comment">// highlight-start</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw24_value = `<code class="language-js"><span class="token comment">// filename: package.json</span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
  ...
  &#125;
	...
	let raw26_value = `<code class="language-js"><span class="token comment">// ...</span>
path<span class="token punctuation">.</span><span class="token method function property-access">replaceWith</span><span class="token punctuation">(</span>
  t<span class="token punctuation">.</span><span class="token method function property-access">variableDeclaration</span><span class="token punctuation">(</span><span class="token string">'const'</span><span class="token punctuation">,</span> <span class="token punctuation">[</span>
    t<span class="token punctuation">.</span><span class="token method function property-access">variableDeclarator</span><span class="token punctuation">(</span>
      t<span class="token punctuation">.</span><span class="token method function property-access">identifier</span><span class="token punctuation">(</span>path<span class="token punctuation">.</span><span class="token method function property-access">get</span><span class="token punctuation">(</span><span class="token string">'id.name'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token property-access">node</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
