...
var baseCss = "http://127.0.0.1:8080/creating-custom-javascript-syntax-with-babel/assets/_blog-299aa480.css";

var image = "http://127.0.0.1:8080/creating-custom-javascript-syntax-with-babel/assets/hero-twitter-ebb286c0.jpg";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fcreating-custom-javascript-syntax-with-babel",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fcreating-custom-javascript-syntax-with-babel");
