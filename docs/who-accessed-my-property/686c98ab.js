...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-js"><span class="token comment">// setting a property in the &#96;$scope&#96; object triggers</span>
<span class="token comment">// the framework to update the model and the DOM</span>
$scope<span class="token punctuation">.</span>name <span class="token operator">=</span> <span class="token string">'Hello'</span><span class="token punctuation">;</span></code>` + "";
	...
	let raw1_value = `<code class="language-js"><span class="token keyword">let</span> _value<span class="token punctuation">;</span>
