...
function create_fragment$1(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-gfyg7l\"]", document.head);
		...
		h() {
			...
			attr(meta5, "name", "twitter:title");
			attr(meta5, "content", "Tan Li Hau");
			attr(meta6, "name", "twitter:description");
			attr(meta6, "content", "Frontend Developer at Shopee Singapore.");
			attr(meta7, "name", "twitter:site");
			attr(meta7, "content", "@lihautan");
			attr(meta8, "name", "twitter:image");
			attr(meta8, "content", twitterImage);
			attr(meta9, "name", "twitter:image:alt");
			attr(meta9, "content", "Tan Li Hau");
			attr(meta10, "name", "twitter:card");
			attr(meta10, "content", "summary_large_image");
