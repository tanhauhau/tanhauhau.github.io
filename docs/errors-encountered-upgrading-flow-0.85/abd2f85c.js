...
function create_default_slot(ctx) {
	...
	let t92;
	let pre0;
	let raw0_value = `<code class="language-js">foobar<span class="token operator">&lt;</span>Type<span class="token operator">></span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span></code>` + "";
	let t93;
	let p10;
	let t94;
	let em0;
	...
	let t97;
	let pre1;
	let raw1_value = `<code class="language-js">foobar <span class="token operator">&lt;</span> Type <span class="token operator">></span> <span class="token number">1</span></code>` + "";
	let t98;
	let p11;
	let em1;
	let t99;
