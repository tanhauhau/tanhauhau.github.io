...
var baseCss = "http://127.0.0.1:8080/compile-svelte-in-your-head-part-4/assets/_blog-299aa480.css";

var image = "http://127.0.0.1:8080/compile-svelte-in-your-head-part-4/assets/hero-twitter-e9eff02b.jpg";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Fcompile-svelte-in-your-head-part-4",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Fcompile-svelte-in-your-head-part-4");
...
function create_default_slot(ctx) {
	...
	let raw_value = `
<code class="language-svelte">&#123;#if condition&#125;
...
&#123;/if&#125;</code>` + "";
	...
	return {
		c() {
			...
			t2 = text("⬅ ⬅  Previously in ");
			a1 = element("a");
			t3 = text("Part 3");
			t4 = text(".");
			t5 = space();
			p1 = element("p");
			t6 = text("In this article, we are going to cover our first logic block, the ");
			strong1 = element("strong");
			t7 = text("if block");
			t8 = text(".");
			t9 = space();
			p2 = element("p");
			t10 = text("To make sure we are on the same page, let's first explain how if block works.");
			t11 = space();
			...
			t15 = space();
			p3 = element("p");
			t16 = text("To render content conditionally, you can wrap it with the ");
			code1 = element("code");
			t17 = text("{#if}");
			t18 = text(" block:");
			t19 = space();
		...
		l(nodes) {
			...
			t2 = claim_text(strong0_nodes, "⬅ ⬅  Previously in ");
			a1 = claim_element(strong0_nodes, "A", { href: true });
			var a1_nodes = children(a1);
			t3 = claim_text(a1_nodes, "Part 3");
			a1_nodes.forEach(detach);
			...
			t6 = claim_text(p1_nodes, "In this article, we are going to cover our first logic block, the ");
			strong1 = claim_element(p1_nodes, "STRONG", {});
			var strong1_nodes = children(strong1);
			t7 = claim_text(strong1_nodes, "if block");
			...
			t10 = claim_text(p2_nodes, "To make sure we are on the same page, let's first explain how if block works.");
			...
			var h2_nodes = children(h2);
			a2 = claim_element(h2_nodes, "A", { href: true, id: true });
			var a2_nodes = children(a2);
			t12 = claim_text(a2_nodes, "The ");
			code0 = claim_element(a2_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t13 = claim_text(code0_nodes, "{#if}");
			code0_nodes.forEach(detach);
			t14 = claim_text(a2_nodes, " block");
			a2_nodes.forEach(detach);
			h2_nodes.forEach(detach);
			t15 = claim_space(section1_nodes);
			p3 = claim_element(section1_nodes, "P", {});
			var p3_nodes = children(p3);
			t16 = claim_text(p3_nodes, "To render content conditionally, you can wrap it with the ");
			code1 = claim_element(p3_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t17 = claim_text(code1_nodes, "{#if}");
			code1_nodes.forEach(detach);
			t18 = claim_text(p3_nodes, " block:");
		...
		h() {
			...
			attr(a1, "href", "/compile-svelte-in-your-head-part-3/");
			attr(a2, "href", "#the-if-block");
			attr(a2, "id", "the-if-block");
