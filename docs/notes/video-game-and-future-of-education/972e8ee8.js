...
var baseCss = "https://lihautan.com/notes/video-game-and-future-of-education/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fvideo-game-and-future-of-education");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			p0 = element("p");
			t0 = text("language is not strictly superior");
			t1 = space();
			p1 = element("p");
			t2 = text("mimicry is effective sometimes, language is effective sometimes\na fusion is superior to either alone");
			t3 = space();
			p2 = element("p");
			t4 = text("when you have language,\nstarts to be able to describe very hypothetical situation, -> stories\nstories can be educational");
			t5 = space();
			p3 = element("p");
			t6 = text("spoken language -> written language\ncan be recorded, text can be kept unchanging -> law\ntext allow us to express exact, specific ideas,");
			t7 = space();
			p4 = element("p");
			t8 = text("the same knowledge at the core, but learning and practice become a different flavour");
		},
		l(nodes) {
			p0 = claim_element(nodes, "P", {});
			var p0_nodes = children(p0);
			t0 = claim_text(p0_nodes, "language is not strictly superior");
			p0_nodes.forEach(detach);
			t1 = claim_space(nodes);
			p1 = claim_element(nodes, "P", {});
			var p1_nodes = children(p1);
			t2 = claim_text(p1_nodes, "mimicry is effective sometimes, language is effective sometimes\na fusion is superior to either alone");
			p1_nodes.forEach(detach);
			t3 = claim_space(nodes);
			p2 = claim_element(nodes, "P", {});
			var p2_nodes = children(p2);
			t4 = claim_text(p2_nodes, "when you have language,\nstarts to be able to describe very hypothetical situation, -> stories\nstories can be educational");
			p2_nodes.forEach(detach);
			t5 = claim_space(nodes);
			p3 = claim_element(nodes, "P", {});
			var p3_nodes = children(p3);
			t6 = claim_text(p3_nodes, "spoken language -> written language\ncan be recorded, text can be kept unchanging -> law\ntext allow us to express exact, specific ideas,");
			p3_nodes.forEach(detach);
			t7 = claim_space(nodes);
			p4 = claim_element(nodes, "P", {});
			var p4_nodes = children(p4);
			t8 = claim_text(p4_nodes, "the same knowledge at the core, but learning and practice become a different flavour");
...
const metadata = {
	...
	"slug": "notes/video-game-and-future-of-education",
	"type": "notes",
	"name": "video-game-and-future-of-education",
	"layout": "note"
};
