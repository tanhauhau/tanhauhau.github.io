...
var baseCss = "https://lihautan.com/notes/css-houdini/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fcss-houdini");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let raw_value = `<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>hero<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("Make custom property animatable");
			t1 = space();
			section1 = element("section");
			h2 = element("h2");
			a1 = element("a");
			t2 = text("Make custom property animatable");
			t3 = space();
			ul1 = element("ul");
			li1 = element("li");
			t4 = text("registerProperty");
			t5 = space();
			pre = element("pre");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "Make custom property animatable");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t2 = claim_text(a1_nodes, "Make custom property animatable");
			a1_nodes.forEach(detach);
			...
			var li1_nodes = children(li1);
			t4 = claim_text(li1_nodes, "registerProperty");
			li1_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#make-custom-property-animatable");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a1, "href", "#make-custom-property-animatable");
			attr(a1, "id", "make-custom-property-animatable");
