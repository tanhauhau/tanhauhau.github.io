...
var baseCss = "https://lihautan.com/notes/graphiql-editor/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fgraphiql-editor");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			ul1 = element("ul");
			li1 = element("li");
			t0 = text("gatsby notes");
			ul0 = element("ul");
			li0 = element("li");
			t1 = text("graphql editor is in http://localhost:8000/___graphql");
		},
		l(nodes) {
			...
			var li1_nodes = children(li1);
			t0 = claim_text(li1_nodes, "gatsby notes");
			ul0 = claim_element(li1_nodes, "UL", {});
			var ul0_nodes = children(ul0);
			li0 = claim_element(ul0_nodes, "LI", {});
			var li0_nodes = children(li0);
			t1 = claim_text(li0_nodes, "graphql editor is in http://localhost:8000/___graphql");
			li0_nodes.forEach(detach);
...
const metadata = {
	...
	"slug": "notes/graphiql-editor",
	"type": "notes",
	"name": "graphiql-editor",
	"layout": "note"
};
