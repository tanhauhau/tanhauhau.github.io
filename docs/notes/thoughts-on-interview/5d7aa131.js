...
var baseCss = "https://lihautan.com/notes/thoughts-on-interview/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fthoughts-on-interview");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("Interview experience from @zhaojinjiang");
			t1 = space();
			section1 = element("section");
			h2 = element("h2");
			a1 = element("a");
			t2 = text("Interview experience from @zhaojinjiang");
			t3 = space();
			ul2 = element("ul");
			li4 = element("li");
			code0 = element("code");
			t4 = text("@zhaojinjiang");
			t5 = text(" shared some of his interview experience");
			ul1 = element("ul");
			li1 = element("li");
			t6 = text("he prepared a ton of questions, but in the end he used 1 question, bubble sort, to eliminate 80% of the candidate");
			t7 = space();
			li2 = element("li");
			t8 = text("he shared one of his prev boss classic interview question, given a DOM node, reverse all it's child element.");
			t9 = space();
			li3 = element("li");
			t10 = text("open-ended question, we have ");
			code1 = element("code");
			t11 = text("insertBefore");
			t12 = text(" and ");
			code2 = element("code");
			t13 = text("appendChild");
			t14 = text(", so if you are given a chance to add a new api, ");
			code3 = element("code");
			t15 = text("insertAfter");
			t16 = text(", explain how you would design the api.");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "Interview experience from @zhaojinjiang");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t2 = claim_text(a1_nodes, "Interview experience from @zhaojinjiang");
			a1_nodes.forEach(detach);
			...
			var li4_nodes = children(li4);
			code0 = claim_element(li4_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t4 = claim_text(code0_nodes, "@zhaojinjiang");
			code0_nodes.forEach(detach);
			t5 = claim_text(li4_nodes, " shared some of his interview experience");
			ul1 = claim_element(li4_nodes, "UL", {});
			var ul1_nodes = children(ul1);
			li1 = claim_element(ul1_nodes, "LI", {});
			var li1_nodes = children(li1);
			t6 = claim_text(li1_nodes, "he prepared a ton of questions, but in the end he used 1 question, bubble sort, to eliminate 80% of the candidate");
			li1_nodes.forEach(detach);
			t7 = claim_space(ul1_nodes);
			li2 = claim_element(ul1_nodes, "LI", {});
			var li2_nodes = children(li2);
			t8 = claim_text(li2_nodes, "he shared one of his prev boss classic interview question, given a DOM node, reverse all it's child element.");
			li2_nodes.forEach(detach);
			t9 = claim_space(ul1_nodes);
			li3 = claim_element(ul1_nodes, "LI", {});
			var li3_nodes = children(li3);
			t10 = claim_text(li3_nodes, "open-ended question, we have ");
			code1 = claim_element(li3_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t11 = claim_text(code1_nodes, "insertBefore");
			code1_nodes.forEach(detach);
			t12 = claim_text(li3_nodes, " and ");
			code2 = claim_element(li3_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t13 = claim_text(code2_nodes, "appendChild");
			code2_nodes.forEach(detach);
			t14 = claim_text(li3_nodes, ", so if you are given a chance to add a new api, ");
			code3 = claim_element(li3_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t15 = claim_text(code3_nodes, "insertAfter");
			code3_nodes.forEach(detach);
			t16 = claim_text(li3_nodes, ", explain how you would design the api.");
			li3_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#interview-experience-from-zhaojinjiang");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a1, "href", "#interview-experience-from-zhaojinjiang");
			attr(a1, "id", "interview-experience-from-zhaojinjiang");
		},
		m(target, anchor) {
...
const metadata = {
	...
	"tags": ["interview"],
	"slug": "notes/thoughts-on-interview",
	"type": "notes",
	"name": "thoughts-on-interview",
	"layout": "note"
};
