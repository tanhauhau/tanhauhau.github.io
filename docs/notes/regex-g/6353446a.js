...
var baseCss = "https://lihautan.com/notes/regex-g/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fregex-g");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-js"><span class="token keyword">const</span> sentence <span class="token operator">=</span> <span class="token string">'car boats car'</span><span class="token punctuation">;</span>
...
regex<span class="token punctuation">.</span><span class="token function">exec</span><span class="token punctuation">(</span>sentence<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// null</span></code>` + "";
	...
	let raw1_value = `<code class="language-js"><span class="token keyword">const</span> regex <span class="token operator">=</span> <span class="token regex">/car/g</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw2_value = `<code class="language-js"><span class="token keyword">const</span> sentence <span class="token operator">=</span> <span class="token string">'car boats car'</span><span class="token punctuation">;</span>
<span class="token keyword">const</span> regex <span class="token operator">=</span> <span class="token regex">/car/g</span><span class="token punctuation">;</span>
...
<span class="token comment">// ...</span></code>` + "";
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("test and exec with  g");
			li1 = element("li");
			a1 = element("a");
			t1 = text("Related Links");
			t2 = space();
			section1 = element("section");
			h20 = element("h2");
			a2 = element("a");
			t3 = text("test and exec with ");
			code0 = element("code");
			t4 = text("g");
			t5 = space();
			p0 = element("p");
			t6 = text("When having a Regex with ");
			code1 = element("code");
			t7 = text("g");
			t8 = text(" (global) flag, the regex instance will store some internal state about the last match.");
			t9 = space();
			p1 = element("p");
			t10 = text("This happens with ");
			code2 = element("code");
			t11 = text("regex.test()");
			t12 = text(" and ");
			code3 = element("code");
			...
			t15 = space();
			p2 = element("p");
			t16 = text("This is useful for the following match + while loop pattern:");
			t17 = space();
			pre1 = element("pre");
			t18 = space();
			p3 = element("p");
			strong = element("strong");
			t19 = text("Note the state is stored in the regex instance");
			t20 = text(", using a different regex instance will not have this behavior:");
			t21 = space();
			pre2 = element("pre");
			t22 = space();
			...
			h21 = element("h2");
			a3 = element("a");
			t23 = text("Related Links");
			t24 = space();
			ul1 = element("ul");
			li2 = element("li");
			a4 = element("a");
			t25 = text("https://stackoverflow.com/questions/15276873/is-javascript-test-saving-state-in-the-regex");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "test and exec with  g");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Related Links");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t3 = claim_text(a2_nodes, "test and exec with ");
			code0 = claim_element(a2_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t4 = claim_text(code0_nodes, "g");
			...
			t6 = claim_text(p0_nodes, "When having a Regex with ");
			code1 = claim_element(p0_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t7 = claim_text(code1_nodes, "g");
			code1_nodes.forEach(detach);
			t8 = claim_text(p0_nodes, " (global) flag, the regex instance will store some internal state about the last match.");
			p0_nodes.forEach(detach);
			t9 = claim_space(section1_nodes);
			p1 = claim_element(section1_nodes, "P", {});
			var p1_nodes = children(p1);
			t10 = claim_text(p1_nodes, "This happens with ");
			code2 = claim_element(p1_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t11 = claim_text(code2_nodes, "regex.test()");
			code2_nodes.forEach(detach);
			t12 = claim_text(p1_nodes, " and ");
			code3 = claim_element(p1_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t13 = claim_text(code3_nodes, "regex.exec()");
			...
			t16 = claim_text(p2_nodes, "This is useful for the following match + while loop pattern:");
			...
			t19 = claim_text(strong_nodes, "Note the state is stored in the regex instance");
			strong_nodes.forEach(detach);
			t20 = claim_text(p3_nodes, ", using a different regex instance will not have this behavior:");
			...
			var a3_nodes = children(a3);
			t23 = claim_text(a3_nodes, "Related Links");
			a3_nodes.forEach(detach);
			...
			var li2_nodes = children(li2);
			a4 = claim_element(li2_nodes, "A", { href: true, rel: true });
			var a4_nodes = children(a4);
			t25 = claim_text(a4_nodes, "https://stackoverflow.com/questions/15276873/is-javascript-test-saving-state-in-the-regex");
			a4_nodes.forEach(detach);
			li2_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#test-and-exec-with-g");
			attr(a1, "href", "#related-links");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a2, "href", "#test-and-exec-with-g");
			attr(a2, "id", "test-and-exec-with-g");
			attr(pre0, "class", "language-js");
			attr(pre1, "class", "language-js");
			attr(pre2, "class", "language-js");
			attr(a3, "href", "#related-links");
			attr(a3, "id", "related-links");
			attr(a4, "href", "https://stackoverflow.com/questions/15276873/is-javascript-test-saving-state-in-the-regex");
