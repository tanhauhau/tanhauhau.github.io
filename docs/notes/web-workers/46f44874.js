...
var baseCss = "https://lihautan.com/notes/web-workers/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fweb-workers");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			ul = element("ul");
			li = element("li");
			t0 = text("When to use workers ");
			a = element("a");
			t1 = text("https://dassur.ma/things/when-workers/");
			this.h();
		},
		l(nodes) {
			...
			t0 = claim_text(li_nodes, "When to use workers ");
			a = claim_element(li_nodes, "A", { href: true, rel: true });
			var a_nodes = children(a);
			t1 = claim_text(a_nodes, "https://dassur.ma/things/when-workers/");
			a_nodes.forEach(detach);
		...
		h() {
			attr(a, "href", "https://dassur.ma/things/when-workers/");
			attr(a, "rel", "nofollow");
		},
		m(target, anchor) {
