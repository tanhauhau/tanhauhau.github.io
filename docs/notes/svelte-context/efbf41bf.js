...
var baseCss = "https://lihautan.com/notes/svelte-context/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fsvelte-context");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li = element("li");
			a0 = element("a");
			t0 = text("React like context");
			t1 = space();
			section1 = element("section");
			h2 = element("h2");
			a1 = element("a");
			t2 = text("React like context");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "React like context");
			a0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t2 = claim_text(a1_nodes, "React like context");
			a1_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#react-like-context");
			attr(ul, "class", "sitemap");
			attr(ul, "id", "sitemap");
			attr(ul, "role", "navigation");
			attr(ul, "aria-label", "Table of Contents");
			attr(a1, "href", "#react-like-context");
			attr(a1, "id", "react-like-context");
		},
		m(target, anchor) {
