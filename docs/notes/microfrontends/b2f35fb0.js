...
var baseCss = "https://lihautan.com/notes/microfrontends/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fmicrofrontends");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			p0 = element("p");
			a0 = element("a");
			t0 = text("https://martinfowler.com/articles/micro-frontends.html");
			t1 = space();
			p1 = element("p");
			t2 = text("Problems:");
			t3 = space();
			...
			li1 = element("li");
			p2 = element("p");
			t4 = text("If router is asynchronously injected, what should you do when visit a route that is ");
			strong = element("strong");
			t5 = text("not yet injected");
			t6 = text("?");
			t7 = space();
			ul0 = element("ul");
			li0 = element("li");
			t8 = text("Define a routing schema, eg, when you are visiting ");
			code0 = element("code");
			t9 = text("/foo/bar");
			t10 = text(" and your local routing registry does not contain the path, you should visit a predefine location for the script/manifest, eg: ");
			code1 = element("code");
			t11 = text("server.com/sites/foo-bar/manifest.json");
			t12 = text(", and load the script. If there's no such file, it meant there's no such path.");
			t13 = space();
			li5 = element("li");
			p3 = element("p");
			t14 = text("Multiple webpack built runtime");
			t15 = space();
			ul1 = element("ul");
			li2 = element("li");
			t16 = text("async chunks will rely on the ");
			code2 = element("code");
			t17 = text("window['webpackJsonp']");
			t18 = text(" to ");
			code3 = element("code");
			t19 = text("require");
			t20 = text(" and ");
			...
			t23 = space();
			li3 = element("li");
			t24 = text("multiple webpack built may have conflicting ");
			code5 = element("code");
			t25 = text("chunkIds");
			t26 = space();
			li4 = element("li");
			t27 = text("thankfully this can be solved via ");
			a1 = element("a");
			t28 = text("webpack-custom-chunk-id-plugin");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "https://martinfowler.com/articles/micro-frontends.html");
			a0_nodes.forEach(detach);
			p0_nodes.forEach(detach);
			t1 = claim_space(nodes);
			p1 = claim_element(nodes, "P", {});
			var p1_nodes = children(p1);
			t2 = claim_text(p1_nodes, "Problems:");
			...
			t4 = claim_text(p2_nodes, "If router is asynchronously injected, what should you do when visit a route that is ");
			strong = claim_element(p2_nodes, "STRONG", {});
			var strong_nodes = children(strong);
			t5 = claim_text(strong_nodes, "not yet injected");
			...
			var li0_nodes = children(li0);
			t8 = claim_text(li0_nodes, "Define a routing schema, eg, when you are visiting ");
			code0 = claim_element(li0_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t9 = claim_text(code0_nodes, "/foo/bar");
			code0_nodes.forEach(detach);
			t10 = claim_text(li0_nodes, " and your local routing registry does not contain the path, you should visit a predefine location for the script/manifest, eg: ");
			code1 = claim_element(li0_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t11 = claim_text(code1_nodes, "server.com/sites/foo-bar/manifest.json");
			code1_nodes.forEach(detach);
			t12 = claim_text(li0_nodes, ", and load the script. If there's no such file, it meant there's no such path.");
			li0_nodes.forEach(detach);
			...
			var li5_nodes = children(li5);
			p3 = claim_element(li5_nodes, "P", {});
			var p3_nodes = children(p3);
			t14 = claim_text(p3_nodes, "Multiple webpack built runtime");
			...
			var li2_nodes = children(li2);
			t16 = claim_text(li2_nodes, "async chunks will rely on the ");
			code2 = claim_element(li2_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t17 = claim_text(code2_nodes, "window['webpackJsonp']");
			code2_nodes.forEach(detach);
			t18 = claim_text(li2_nodes, " to ");
			code3 = claim_element(li2_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t19 = claim_text(code3_nodes, "require");
			code3_nodes.forEach(detach);
			t20 = claim_text(li2_nodes, " and ");
			code4 = claim_element(li2_nodes, "CODE", {});
			var code4_nodes = children(code4);
			t21 = claim_text(code4_nodes, "exports");
			code4_nodes.forEach(detach);
			t22 = claim_text(li2_nodes, " module.");
			li2_nodes.forEach(detach);
			t23 = claim_space(ul1_nodes);
			li3 = claim_element(ul1_nodes, "LI", {});
			var li3_nodes = children(li3);
			t24 = claim_text(li3_nodes, "multiple webpack built may have conflicting ");
			code5 = claim_element(li3_nodes, "CODE", {});
			var code5_nodes = children(code5);
			t25 = claim_text(code5_nodes, "chunkIds");
			code5_nodes.forEach(detach);
			li3_nodes.forEach(detach);
			t26 = claim_space(ul1_nodes);
			li4 = claim_element(ul1_nodes, "LI", {});
			var li4_nodes = children(li4);
			t27 = claim_text(li4_nodes, "thankfully this can be solved via ");
			a1 = claim_element(li4_nodes, "A", { href: true, rel: true });
			var a1_nodes = children(a1);
			t28 = claim_text(a1_nodes, "webpack-custom-chunk-id-plugin");
			a1_nodes.forEach(detach);
			li4_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "https://martinfowler.com/articles/micro-frontends.html");
			attr(a0, "rel", "nofollow");
			attr(a1, "href", "https://github.com/darshanlsagar/webpack-custom-chunk-id-plugin");
