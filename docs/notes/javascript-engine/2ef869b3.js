...
var baseCss = "https://lihautan.com/notes/javascript-engine/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fjavascript-engine");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			ul0 = element("ul");
			li0 = element("li");
			t1 = text("On Environment Records: ");
			a = element("a");
			t2 = text("http://dmitrysoshnikov.com/ecmascript/es5-chapter-3-2-lexical-environments-ecmascript-implementation/");
			this.h();
		},
		l(nodes) {
			...
			var li1_nodes = children(li1);
			t0 = claim_text(li1_nodes, "Build a JavaScript Engine with Rust");
			ul0 = claim_element(li1_nodes, "UL", {});
			var ul0_nodes = children(ul0);
			li0 = claim_element(ul0_nodes, "LI", {});
			var li0_nodes = children(li0);
			t1 = claim_text(li0_nodes, "On Environment Records: ");
			a = claim_element(li0_nodes, "A", { href: true, rel: true });
			var a_nodes = children(a);
			t2 = claim_text(a_nodes, "http://dmitrysoshnikov.com/ecmascript/es5-chapter-3-2-lexical-environments-ecmascript-implementation/");
			a_nodes.forEach(detach);
			li0_nodes.forEach(detach);
		...
		h() {
			attr(a, "href", "http://dmitrysoshnikov.com/ecmascript/es5-chapter-3-2-lexical-environments-ecmascript-implementation/");
			attr(a, "rel", "nofollow");
		},
		m(target, anchor) {
