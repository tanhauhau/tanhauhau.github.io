...
var baseCss = "https://lihautan.com/notes/regex-lazy/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fregex-lazy");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let raw_value = `<code class="language-js"><span class="token keyword">const</span> sentence <span class="token operator">=</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">a "witch" and her "broom" is one</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>

sentence<span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex">/".+"/</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// &#96;"witch" and her "broom"&#96;</span>
<span class="token comment">// lazy</span>
sentence<span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex">/".+?"/</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// &#96;"witch"&#96;</span></code>` + "";
	...
	return {
		c() {
			p0 = element("p");
			t0 = text("Lazy quantifier in regex ");
			code0 = element("code");
			t1 = text("?");
			t2 = space();
			p1 = element("p");
			...
			code1 = element("code");
			t4 = text("?");
			t5 = text(" at the behind ");
			code2 = element("code");
			t6 = text("*");
			t7 = text(" or ");
			code3 = element("code");
			t8 = text("+");
			t9 = text(" to make them less greedy.");
			t10 = space();
			pre = element("pre");
			t11 = space();
			ul = element("ul");
			li0 = element("li");
			a0 = element("a");
			t12 = text("https://twitter.com/lihautan/status/1177476277277560832");
			t13 = space();
			li1 = element("li");
			a1 = element("a");
			t14 = text("https://javascript.info/regexp-greedy-and-lazy");
			this.h();
		},
		l(nodes) {
			p0 = claim_element(nodes, "P", {});
			var p0_nodes = children(p0);
			t0 = claim_text(p0_nodes, "Lazy quantifier in regex ");
			...
			t3 = claim_text(p1_nodes, "Add ");
			code1 = claim_element(p1_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t4 = claim_text(code1_nodes, "?");
			code1_nodes.forEach(detach);
			t5 = claim_text(p1_nodes, " at the behind ");
			code2 = claim_element(p1_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t6 = claim_text(code2_nodes, "*");
			code2_nodes.forEach(detach);
			t7 = claim_text(p1_nodes, " or ");
			code3 = claim_element(p1_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t8 = claim_text(code3_nodes, "+");
			code3_nodes.forEach(detach);
			t9 = claim_text(p1_nodes, " to make them less greedy.");
			...
			var a0_nodes = children(a0);
			t12 = claim_text(a0_nodes, "https://twitter.com/lihautan/status/1177476277277560832");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			t13 = claim_space(ul_nodes);
			...
			var a1_nodes = children(a1);
			t14 = claim_text(a1_nodes, "https://javascript.info/regexp-greedy-and-lazy");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			ul_nodes.forEach(detach);
			this.h();
		...
		h() {
			...
			attr(a0, "href", "https://twitter.com/lihautan/status/1177476277277560832");
			attr(a0, "rel", "nofollow");
			attr(a1, "href", "https://javascript.info/regexp-greedy-and-lazy");
