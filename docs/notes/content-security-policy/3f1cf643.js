...
var baseCss = "https://lihautan.com/notes/content-security-policy/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fcontent-security-policy");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("https://w3c.github.io/webappsec-cspee/");
			t1 = space();
			li1 = element("li");
			a1 = element("a");
			t2 = text("https://en.wikipedia.org/wiki/Content_Security_Policy");
			t3 = space();
			li2 = element("li");
			a2 = element("a");
			t4 = text("https://en.wikipedia.org/wiki/Clickjacking");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "https://w3c.github.io/webappsec-cspee/");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			t1 = claim_space(ul_nodes);
			...
			var a1_nodes = children(a1);
			t2 = claim_text(a1_nodes, "https://en.wikipedia.org/wiki/Content_Security_Policy");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			t3 = claim_space(ul_nodes);
			...
			var a2_nodes = children(a2);
			t4 = claim_text(a2_nodes, "https://en.wikipedia.org/wiki/Clickjacking");
			a2_nodes.forEach(detach);
			li2_nodes.forEach(detach);
			ul_nodes.forEach(detach);
			this.h();
...
const metadata = {
	...
	"tags": ["web security"],
	"slug": "notes/content-security-policy",
	"type": "notes",
