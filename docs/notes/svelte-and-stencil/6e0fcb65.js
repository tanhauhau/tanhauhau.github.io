...
var baseCss = "https://lihautan.com/notes/svelte-and-stencil/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fsvelte-and-stencil");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			ul1 = element("ul");
			li0 = element("li");
			t0 = text("@sunchenchen did a sharing on ");
			a = element("a");
		...
		l(nodes) {
			...
			var li0_nodes = children(li0);
			t0 = claim_text(li0_nodes, "@sunchenchen did a sharing on ");
...
const metadata = {
	...
	"tags": ["svelte", "stencil"],
	"slug": "notes/svelte-and-stencil",
	"type": "notes",
	"name": "svelte-and-stencil",
	"layout": "note"
};
