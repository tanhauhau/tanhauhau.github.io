...
var baseCss = "https://lihautan.com/notes/2019-07-02 - my gatsby site/assets/blog-base-ed21726f.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta2, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2F2019-07-02%20-%20my%20gatsby%20site");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let raw_value = `
<code class="language-js"><span class="token comment">// gatsby-node.js</span>
...
<span class="token keyword module">export</span> <span class="token keyword">const</span> pageQuery <span class="token operator">=</span> graphql<span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token graphql language-graphql">
  <span class="token keyword">query</span> BlogPostBySlug<span class="token punctuation">(</span><span class="token variable">$slug</span><span class="token punctuation">:</span> String<span class="token operator">!</span><span class="token punctuation">,</span> <span class="token variable">$foo</span><span class="token punctuation">:</span> String<span class="token operator">!</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token punctuation">&#125;</span>
	...
	return {
		...
		l(nodes) {
			...
			t12 = claim_text(p_nodes, "[Added 14 Sept 2019]");
			...
			ul4 = claim_element(nodes, "UL", {});
			var ul4_nodes = children(ul4);
			li8 = claim_element(ul4_nodes, "LI", {});
			var li8_nodes = children(li8);
			t23 = claim_text(li8_nodes, "if you are creating ");
			code3 = claim_element(li8_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t24 = claim_text(code3_nodes, "slug");
			code3_nodes.forEach(detach);
			t25 = claim_text(li8_nodes, " from page url, and it contains ");
			code4 = claim_element(li8_nodes, "CODE", {});
			var code4_nodes = children(code4);
			t26 = claim_text(code4_nodes, "<space>");
			code4_nodes.forEach(detach);
			t27 = claim_text(li8_nodes, " characters, you might need to do\n");
			code5 = claim_element(li8_nodes, "CODE", {});
			var code5_nodes = children(code5);
			t28 = claim_text(code5_nodes, "slug.replace(/\\s+/g, '-')");
			code5_nodes.forEach(detach);
			t29 = claim_text(li8_nodes, " as browser will ");
			code6 = claim_element(li8_nodes, "CODE", {});
			var code6_nodes = children(code6);
			t30 = claim_text(code6_nodes, "encodeUriComponent");
			code6_nodes.forEach(detach);
			t31 = claim_text(li8_nodes, " of your path, and the slug may not match.");
...
const metadata = {
	"slug": "notes/2019-07-02 - my gatsby site",
	"type": "notes",
	"date": "2019-07-02",
	"name": "my gatsby site",
	"layout": "note"
