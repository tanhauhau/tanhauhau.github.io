...
var baseCss = "https://lihautan.com/notes/react-tearing/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Freact-tearing");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			p0 = element("p");
			t0 = text("Saw an issue about ");
			a0 = element("a");
			t1 = text("fixing tearing issue in React");
			t2 = space();
			p1 = element("p");
			t3 = text("A good explanation of tearing is here: ");
			a1 = element("a");
			t4 = text("https://stackoverflow.com/questions/54891675/what-is-tearing-in-the-context-of-the-react-redux");
			t5 = space();
			p2 = element("p");
			t6 = text("In short, tearing is an potential issue when React concurrent mode interacts with external state management tools.");
			t7 = space();
			p3 = element("p");
			t8 = text("React Concurrent mode allows React to render asynchronously. Rendering phase is no longer happening at one go, but split up into multiple small chunks.\nAnd the tearing issue arise if the external state changes in the middle of rendering phase, causing part of the application rendered\nwith the old data, and part with the latest data.");
			t9 = space();
			p4 = element("p");
			t10 = text("This somehow reminds me of the zombie child, stale props issue of redux: ");
			a2 = element("a");
			t11 = text("https://kaihao.dev/posts/Stale-props-and-zombie-children-in-Redux");
			this.h();
		},
		l(nodes) {
			p0 = claim_element(nodes, "P", {});
			var p0_nodes = children(p0);
			t0 = claim_text(p0_nodes, "Saw an issue about ");
			a0 = claim_element(p0_nodes, "A", { href: true, rel: true });
			var a0_nodes = children(a0);
			t1 = claim_text(a0_nodes, "fixing tearing issue in React");
			a0_nodes.forEach(detach);
			p0_nodes.forEach(detach);
			t2 = claim_space(nodes);
			p1 = claim_element(nodes, "P", {});
			var p1_nodes = children(p1);
			t3 = claim_text(p1_nodes, "A good explanation of tearing is here: ");
			a1 = claim_element(p1_nodes, "A", { href: true, rel: true });
			var a1_nodes = children(a1);
			t4 = claim_text(a1_nodes, "https://stackoverflow.com/questions/54891675/what-is-tearing-in-the-context-of-the-react-redux");
			a1_nodes.forEach(detach);
			p1_nodes.forEach(detach);
			t5 = claim_space(nodes);
			p2 = claim_element(nodes, "P", {});
			var p2_nodes = children(p2);
			t6 = claim_text(p2_nodes, "In short, tearing is an potential issue when React concurrent mode interacts with external state management tools.");
			p2_nodes.forEach(detach);
			t7 = claim_space(nodes);
			p3 = claim_element(nodes, "P", {});
			var p3_nodes = children(p3);
			t8 = claim_text(p3_nodes, "React Concurrent mode allows React to render asynchronously. Rendering phase is no longer happening at one go, but split up into multiple small chunks.\nAnd the tearing issue arise if the external state changes in the middle of rendering phase, causing part of the application rendered\nwith the old data, and part with the latest data.");
			p3_nodes.forEach(detach);
			t9 = claim_space(nodes);
			p4 = claim_element(nodes, "P", {});
			var p4_nodes = children(p4);
			t10 = claim_text(p4_nodes, "This somehow reminds me of the zombie child, stale props issue of redux: ");
			a2 = claim_element(p4_nodes, "A", { href: true, rel: true });
			var a2_nodes = children(a2);
			t11 = claim_text(a2_nodes, "https://kaihao.dev/posts/Stale-props-and-zombie-children-in-Redux");
			a2_nodes.forEach(detach);
			p4_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(a0, "href", "https://github.com/facebook/react/pull/16623");
			attr(a0, "rel", "nofollow");
			attr(a1, "href", "https://stackoverflow.com/questions/54891675/what-is-tearing-in-the-context-of-the-react-redux");
			attr(a1, "rel", "nofollow");
			attr(a2, "href", "https://kaihao.dev/posts/Stale-props-and-zombie-children-in-Redux");
...
const metadata = {
	"title": "React Tearing",
	"tags": ["tearing", "rendering", "zombie child"],
	"slug": "notes/react-tearing",
	"type": "notes",
	"name": "react-tearing",
	"layout": "note"
};
