...
var baseCss = "https://lihautan.com/notes/movie-to-gif/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fmovie-to-gif");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let t2;
	let pre;
	let raw_value = `<code class="language-sh">ffmpeg -i ~/Desktop/darkmode.mov -filter_complex <span class="token string">"[0:v] fps=40, setpts=0.5*PTS"</span> -f gif ~/Desktop/darkmode-2.gif</code>` + "";
	let t3;
	let p1;
	let code1;
	let t4;
