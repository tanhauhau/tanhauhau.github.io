...
var baseCss = "https://lihautan.com/notes/button-that-spark-joy/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fbutton-that-spark-joy");
			attr(a, "href", "#content");
...
/* content/notes/button-that-spark-joy/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("Confirm Confetti Button");
			ul0 = element("ul");
			li1 = element("li");
			a1 = element("a");
			t1 = text("Button tilted in the direction of the mouse cursor");
			t2 = space();
			blockquote = element("blockquote");
			p0 = element("p");
			t3 = text("Notes for reading ");
			a2 = element("a");
			t4 = text("Frontend Horse: Button that Spark Joy");
			t5 = space();
			section1 = element("section");
			h2 = element("h2");
			a3 = element("a");
			t6 = text("Confirm Confetti Button");
			t7 = space();
			p1 = element("p");
			t8 = text("There's so much more details than the confetti cannon");
			t9 = space();
			section2 = element("section");
			h3 = element("h3");
			a4 = element("a");
			t10 = text("Button tilted in the direction of the mouse cursor");
			t11 = space();
			ul2 = element("ul");
			li2 = element("li");
			t12 = text("transform ");
			code0 = element("code");
			t13 = text("::before");
			t14 = text(" instead of the button itself, because the hover hit area will change as we transform the button.");
			t15 = space();
			li3 = element("li");
			t16 = text("use ");
			code1 = element("code");
			...
			t20 = space();
			li4 = element("li");
			t21 = text("transformZ, for some parallex kind of effect");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "Confirm Confetti Button");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Button tilted in the direction of the mouse cursor");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			t3 = claim_text(p0_nodes, "Notes for reading ");
			a2 = claim_element(p0_nodes, "A", { href: true, rel: true });
			var a2_nodes = children(a2);
			t4 = claim_text(a2_nodes, "Frontend Horse: Button that Spark Joy");
			a2_nodes.forEach(detach);
			...
			a3 = claim_element(h2_nodes, "A", { href: true, id: true });
			var a3_nodes = children(a3);
			t6 = claim_text(a3_nodes, "Confirm Confetti Button");
			a3_nodes.forEach(detach);
			h2_nodes.forEach(detach);
			t7 = claim_space(section1_nodes);
			p1 = claim_element(section1_nodes, "P", {});
			var p1_nodes = children(p1);
			t8 = claim_text(p1_nodes, "There's so much more details than the confetti cannon");
			...
			var a4_nodes = children(a4);
			t10 = claim_text(a4_nodes, "Button tilted in the direction of the mouse cursor");
			a4_nodes.forEach(detach);
			...
			var li2_nodes = children(li2);
			t12 = claim_text(li2_nodes, "transform ");
			code0 = claim_element(li2_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t13 = claim_text(code0_nodes, "::before");
			code0_nodes.forEach(detach);
			t14 = claim_text(li2_nodes, " instead of the button itself, because the hover hit area will change as we transform the button.");
			li2_nodes.forEach(detach);
			t15 = claim_space(ul2_nodes);
			li3 = claim_element(ul2_nodes, "LI", {});
			var li3_nodes = children(li3);
			t16 = claim_text(li3_nodes, "use ");
			code1 = claim_element(li3_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t17 = claim_text(code1_nodes, "rotateX");
			code1_nodes.forEach(detach);
			t18 = claim_text(li3_nodes, " and ");
			code2 = claim_element(li3_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t19 = claim_text(code2_nodes, "rotateY");
			code2_nodes.forEach(detach);
			li3_nodes.forEach(detach);
			t20 = claim_space(ul2_nodes);
			li4 = claim_element(ul2_nodes, "LI", {});
			var li4_nodes = children(li4);
			t21 = claim_text(li4_nodes, "transformZ, for some parallex kind of effect");
			li4_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#confirm-confetti-button");
			attr(a1, "href", "#button-tilted-in-the-direction-of-the-mouse-cursor");
			attr(ul1, "class", "sitemap");
			attr(ul1, "id", "sitemap");
			attr(ul1, "role", "navigation");
			attr(ul1, "aria-label", "Table of Contents");
			attr(a2, "href", "https://frontend.horse/articles/buttons-that-spark-joy/");
			attr(a2, "rel", "nofollow");
			attr(a3, "href", "#confirm-confetti-button");
			attr(a3, "id", "confirm-confetti-button");
			attr(a4, "href", "#button-tilted-in-the-direction-of-the-mouse-cursor");
			attr(a4, "id", "button-tilted-in-the-direction-of-the-mouse-cursor");
		},
		m(target, anchor) {
...
const metadata = {
	...
	"tags": ["CSS transform", "GreenSock Animation"],
	"slug": "notes/button-that-spark-joy",
	"type": "notes",
	"name": "button-that-spark-joy",
	"layout": "note"
};
