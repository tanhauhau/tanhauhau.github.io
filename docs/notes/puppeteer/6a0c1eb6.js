...
var baseCss = "https://lihautan.com/notes/puppeteer/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fpuppeteer");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let t3;
	let pre;
	let raw_value = `<code class="language-js">puppeteer<span class="token punctuation">.</span><span class="token function">launch</span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> args<span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">'--remote-debugging-port=12345'</span><span class="token punctuation">]</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span></code>` + "";
	let t4;
	let p1;
	let t5;
	let t6;
