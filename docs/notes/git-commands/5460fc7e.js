...
var baseCss = "https://lihautan.com/notes/git-commands/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fgit-commands");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li2 = element("li");
			p0 = element("p");
			t5 = text("To show files changed in the last stash\n");
			code0 = element("code");
			t6 = text("git stash show");
			t7 = space();
			li3 = element("li");
			p1 = element("p");
			t8 = text("To show content in the last stash\n");
			code1 = element("code");
			t9 = text("git stash show -p");
			t10 = space();
			li4 = element("li");
			p2 = element("p");
			t11 = text("To show content of a stash\n");
			code2 = element("code");
			t12 = text("git stash show -p stash@{1}");
			t13 = space();
			section2 = element("section");
			h21 = element("h2");
			a3 = element("a");
			t14 = text("Talks on git commands");
			t15 = space();
			ul2 = element("ul");
			li5 = element("li");
			a4 = element("a");
		...
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "git stash");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Talks on git commands");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t3 = claim_text(a2_nodes, "git stash");
			a2_nodes.forEach(detach);
			...
			t5 = claim_text(p0_nodes, "To show files changed in the last stash\n");
			code0 = claim_element(p0_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t6 = claim_text(code0_nodes, "git stash show");
			...
			var li3_nodes = children(li3);
			p1 = claim_element(li3_nodes, "P", {});
			var p1_nodes = children(p1);
			t8 = claim_text(p1_nodes, "To show content in the last stash\n");
			code1 = claim_element(p1_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t9 = claim_text(code1_nodes, "git stash show -p");
			...
			var li4_nodes = children(li4);
			p2 = claim_element(li4_nodes, "P", {});
			var p2_nodes = children(p2);
			t11 = claim_text(p2_nodes, "To show content of a stash\n");
			code2 = claim_element(p2_nodes, "CODE", {});
			var code2_nodes = children(code2);
			t12 = claim_text(code2_nodes, "git stash show -p stash@{1}");
			...
			var a3_nodes = children(a3);
			t14 = claim_text(a3_nodes, "Talks on git commands");
			a3_nodes.forEach(detach);
			...
			var li5_nodes = children(li5);
			a4 = claim_element(li5_nodes, "A", { href: true });
			var a4_nodes = children(a4);
			t16 = claim_text(a4_nodes, "Git Gudder");
			a4_nodes.forEach(detach);
			li5_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#git-stash");
			attr(a1, "href", "#talks-on-git-commands");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a2, "href", "#git-stash");
			attr(a2, "id", "git-stash");
			attr(a3, "href", "#talks-on-git-commands");
			attr(a3, "id", "talks-on-git-commands");
			attr(a4, "href", "/git-gudder/");
		},
		m(target, anchor) {
