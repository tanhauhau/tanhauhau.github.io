...
var baseCss = "https://lihautan.com/notes/why-write-architectural-decision-records/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fwhy-write-architectural-decision-records");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("For the future you");
			li1 = element("li");
			a1 = element("a");
			t1 = text("For your peers");
			li2 = element("li");
			a2 = element("a");
			t2 = text("For your future peers");
			li3 = element("li");
			a3 = element("a");
			t3 = text("Links");
			t4 = space();
			...
			h20 = element("h2");
			a4 = element("a");
			t5 = text("For the future you");
			t6 = space();
			ul1 = element("ul");
			li4 = element("li");
			t7 = text("captures the decision at the time it's written");
			t8 = space();
			li5 = element("li");
			t9 = text("help you recall what your mindset was when you decided upon that architecture");
			t10 = space();
			li6 = element("li");
			t11 = text("save the future you time, you can just link people to the ADR instead of spending time explain");
			t12 = space();
			section2 = element("section");
			h21 = element("h2");
			a5 = element("a");
			t13 = text("For your peers");
			t14 = space();
			ul2 = element("ul");
			li7 = element("li");
			t15 = text("Provide understanding of the tradeoffs and the considerations");
			t16 = space();
			li8 = element("li");
			t17 = text("Provide a bigger context of the change, and how it works in a larger system");
			t18 = space();
			li9 = element("li");
			t19 = text("Get better pull request reviews");
			t20 = space();
			section3 = element("section");
			h22 = element("h2");
			a6 = element("a");
			t21 = text("For your future peers");
			t22 = space();
			ul3 = element("ul");
			li10 = element("li");
			t23 = text("Helps scale onboarding new team members");
			t24 = space();
			li11 = element("li");
			t25 = text("Allow your teammates to write a new ADR that supersededs the current ADR");
			t26 = space();
			...
			li12 = element("li");
			a8 = element("a");
			t29 = text("Why Write ADRs");
			t30 = text(" by ");
			a9 = element("a");
			t31 = text("@_eliperkins");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "For the future you");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "For your peers");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t2 = claim_text(a2_nodes, "For your future peers");
			a2_nodes.forEach(detach);
			li2_nodes.forEach(detach);
			...
			var a4_nodes = children(a4);
			t5 = claim_text(a4_nodes, "For the future you");
			a4_nodes.forEach(detach);
			...
			var li4_nodes = children(li4);
			t7 = claim_text(li4_nodes, "captures the decision at the time it's written");
			li4_nodes.forEach(detach);
			t8 = claim_space(ul1_nodes);
			li5 = claim_element(ul1_nodes, "LI", {});
			var li5_nodes = children(li5);
			t9 = claim_text(li5_nodes, "help you recall what your mindset was when you decided upon that architecture");
			li5_nodes.forEach(detach);
			t10 = claim_space(ul1_nodes);
			li6 = claim_element(ul1_nodes, "LI", {});
			var li6_nodes = children(li6);
			t11 = claim_text(li6_nodes, "save the future you time, you can just link people to the ADR instead of spending time explain");
			li6_nodes.forEach(detach);
			...
			var a5_nodes = children(a5);
			t13 = claim_text(a5_nodes, "For your peers");
			a5_nodes.forEach(detach);
			...
			var li7_nodes = children(li7);
			t15 = claim_text(li7_nodes, "Provide understanding of the tradeoffs and the considerations");
			li7_nodes.forEach(detach);
			t16 = claim_space(ul2_nodes);
			li8 = claim_element(ul2_nodes, "LI", {});
			var li8_nodes = children(li8);
			t17 = claim_text(li8_nodes, "Provide a bigger context of the change, and how it works in a larger system");
			li8_nodes.forEach(detach);
			t18 = claim_space(ul2_nodes);
			li9 = claim_element(ul2_nodes, "LI", {});
			var li9_nodes = children(li9);
			t19 = claim_text(li9_nodes, "Get better pull request reviews");
			...
			var a6_nodes = children(a6);
			t21 = claim_text(a6_nodes, "For your future peers");
			a6_nodes.forEach(detach);
			...
			t23 = claim_text(li10_nodes, "Helps scale onboarding new team members");
			li10_nodes.forEach(detach);
			t24 = claim_space(ul3_nodes);
			li11 = claim_element(ul3_nodes, "LI", {});
			var li11_nodes = children(li11);
			t25 = claim_text(li11_nodes, "Allow your teammates to write a new ADR that supersededs the current ADR");
			...
			a7 = claim_element(h23_nodes, "A", { href: true, id: true });
			var a7_nodes = children(a7);
			t27 = claim_text(a7_nodes, "Links");
			a7_nodes.forEach(detach);
			h23_nodes.forEach(detach);
			t28 = claim_space(section4_nodes);
			ul4 = claim_element(section4_nodes, "UL", {});
			var ul4_nodes = children(ul4);
			li12 = claim_element(ul4_nodes, "LI", {});
			var li12_nodes = children(li12);
			a8 = claim_element(li12_nodes, "A", { href: true, rel: true });
			var a8_nodes = children(a8);
			t29 = claim_text(a8_nodes, "Why Write ADRs");
			a8_nodes.forEach(detach);
			t30 = claim_text(li12_nodes, " by ");
			a9 = claim_element(li12_nodes, "A", { href: true, rel: true });
			var a9_nodes = children(a9);
			t31 = claim_text(a9_nodes, "@_eliperkins");
		...
		h() {
			attr(a0, "href", "#for-the-future-you");
			attr(a1, "href", "#for-your-peers");
			attr(a2, "href", "#for-your-future-peers");
			attr(a3, "href", "#links");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a4, "href", "#for-the-future-you");
			attr(a4, "id", "for-the-future-you");
			attr(a5, "href", "#for-your-peers");
			attr(a5, "id", "for-your-peers");
			attr(a6, "href", "#for-your-future-peers");
			attr(a6, "id", "for-your-future-peers");
			attr(a7, "href", "#links");
			attr(a7, "id", "links");
			attr(a8, "href", "https://github.blog/2020-08-13-why-write-adrs/");
			attr(a8, "rel", "nofollow");
			attr(a9, "href", "https://twitter.com/_eliperkins");
...
const metadata = {
	...
	"tags": ["Architectural Decision Records"],
	"slug": "notes/why-write-architectural-decision-records",
	"type": "notes",
	"name": "why-write-architectural-decision-records",
	"layout": "note"
};
