...
var baseCss = "https://lihautan.com/notes/module-federation/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fmodule-federation");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			ul = element("ul");
			li0 = element("li");
			t0 = text("Github issues: ");
			a0 = element("a");
			t1 = text("https://github.com/webpack/webpack/issues/10352");
			t2 = space();
			li1 = element("li");
			a1 = element("a");
			t3 = text("https://medium.com/swlh/webpack-5-module-federation-a-game-changer-to-javascript-architecture-bcdd30e02669");
			t4 = space();
			li2 = element("li");
			a2 = element("a");
			t5 = text("https://medium.com/dev-genius/module-federation-advanced-api-inwebpack-5-0-0-beta-17-71cd4d42e534");
			t6 = space();
			li3 = element("li");
			a3 = element("a");
			t7 = text("https://www.youtube.com/playlist?list=PLWSiF9YHHK-DqsFHGYbeAMwbd9xcZbEWJ");
			t8 = space();
			li4 = element("li");
			a4 = element("a");
			t9 = text("https://levelup.gitconnected.com/micro-frontend-architecture-replacing-a-monolith-from-the-inside-out-61f60d2e14c1");
			t10 = space();
			li5 = element("li");
			a5 = element("a");
			t11 = text("https://webpack.js.org/concepts/module-federation/");
			t12 = space();
			li6 = element("li");
			a6 = element("a");
			t13 = text("https://github.com/module-federation");
			t14 = space();
			li7 = element("li");
			t15 = text("Streamed federation ");
			a7 = element("a");
			t16 = text("https://www.youtube.com/watch?v=kOuoSBTCzl4");
			this.h();
		},
		l(nodes) {
			...
			var li0_nodes = children(li0);
			t0 = claim_text(li0_nodes, "Github issues: ");
			a0 = claim_element(li0_nodes, "A", { href: true, rel: true });
			var a0_nodes = children(a0);
			t1 = claim_text(a0_nodes, "https://github.com/webpack/webpack/issues/10352");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t3 = claim_text(a1_nodes, "https://medium.com/swlh/webpack-5-module-federation-a-game-changer-to-javascript-architecture-bcdd30e02669");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t5 = claim_text(a2_nodes, "https://medium.com/dev-genius/module-federation-advanced-api-inwebpack-5-0-0-beta-17-71cd4d42e534");
			a2_nodes.forEach(detach);
			li2_nodes.forEach(detach);
			...
			var a3_nodes = children(a3);
			t7 = claim_text(a3_nodes, "https://www.youtube.com/playlist?list=PLWSiF9YHHK-DqsFHGYbeAMwbd9xcZbEWJ");
			a3_nodes.forEach(detach);
			li3_nodes.forEach(detach);
			...
			var a4_nodes = children(a4);
			t9 = claim_text(a4_nodes, "https://levelup.gitconnected.com/micro-frontend-architecture-replacing-a-monolith-from-the-inside-out-61f60d2e14c1");
			a4_nodes.forEach(detach);
			li4_nodes.forEach(detach);
			...
			var a5_nodes = children(a5);
			t11 = claim_text(a5_nodes, "https://webpack.js.org/concepts/module-federation/");
			a5_nodes.forEach(detach);
			li5_nodes.forEach(detach);
			...
			var a6_nodes = children(a6);
			t13 = claim_text(a6_nodes, "https://github.com/module-federation");
			a6_nodes.forEach(detach);
			li6_nodes.forEach(detach);
			t14 = claim_space(ul_nodes);
			li7 = claim_element(ul_nodes, "LI", {});
			var li7_nodes = children(li7);
			t15 = claim_text(li7_nodes, "Streamed federation ");
			a7 = claim_element(li7_nodes, "A", { href: true, rel: true });
			var a7_nodes = children(a7);
			t16 = claim_text(a7_nodes, "https://www.youtube.com/watch?v=kOuoSBTCzl4");
			a7_nodes.forEach(detach);
			li7_nodes.forEach(detach);
			ul_nodes.forEach(detach);
			this.h();
		...
		h() {
			attr(a0, "href", "https://github.com/webpack/webpack/issues/10352");
			attr(a0, "rel", "nofollow");
			attr(a1, "href", "https://medium.com/swlh/webpack-5-module-federation-a-game-changer-to-javascript-architecture-bcdd30e02669");
			attr(a1, "rel", "nofollow");
			attr(a2, "href", "https://medium.com/dev-genius/module-federation-advanced-api-inwebpack-5-0-0-beta-17-71cd4d42e534");
			attr(a2, "rel", "nofollow");
			attr(a3, "href", "https://www.youtube.com/playlist?list=PLWSiF9YHHK-DqsFHGYbeAMwbd9xcZbEWJ");
			attr(a3, "rel", "nofollow");
			attr(a4, "href", "https://levelup.gitconnected.com/micro-frontend-architecture-replacing-a-monolith-from-the-inside-out-61f60d2e14c1");
			attr(a4, "rel", "nofollow");
			attr(a5, "href", "https://webpack.js.org/concepts/module-federation/");
			attr(a5, "rel", "nofollow");
			attr(a6, "href", "https://github.com/module-federation");
			attr(a6, "rel", "nofollow");
			attr(a7, "href", "https://www.youtube.com/watch?v=kOuoSBTCzl4");
