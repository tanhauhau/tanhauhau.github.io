...
var baseCss = "https://lihautan.com/notes/blog-inspiration/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fblog-inspiration");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("String.matchAll bug in Babel");
			t1 = space();
			section1 = element("section");
			h2 = element("h2");
			a1 = element("a");
			t2 = text("String.matchAll bug in Babel");
			t3 = space();
			ul2 = element("ul");
			li1 = element("li");
			p0 = element("p");
			a2 = element("a");
			t4 = text("https://github.com/babel/babel/issues/10134");
			t5 = space();
			li2 = element("li");
			p1 = element("p");
			t6 = text("repl: ");
			a3 = element("a");
			t7 = text("https://babeljs.io/en/repl#?babili=false&browsers=&build=&builtIns=false&spec=false&loose=false&code_lz=MYewdgzgLgBNBOBLMBzGBeGByAYgQwDcQkoBTGAcUSgAkBXAIxnlIAcQIAuGKYAZgCcAelLAAtngBMANkkwCADiGKAdABNSBLAG4AUKEiwWKUgA8MMIQB0GACgD8AHhAB3MKXgA-ANp4AtABeAAx-AgC6ANQAlFZCDo4s7D7-waFWKpExDEIoeroAZsQwtgbQMBK8ABYwIPlwUEioKhXAlQCCADYdtsZmUVEwAN66MDClIB2kKh0gKLYABgAkgy2V3kFhAL4weLDLqyrIGqbbLtTVWPu7rYdgrHRQm1jzUXqj45PTswuASYQ1bh5uFcqioUPAQHRWBAVK53PBNi83mNwBAJlMZnN5n9EiAgStrpVQeDIdCcQjXrpNkA&debug=true&forceAllTransforms=false&shippedProposals=false&circleciRepo=&evaluate=false&fileSize=false&timeTravel=false&sourceType=module&lineWrap=false&presets=env&prettier=false&targets=Node-9&version=7.4.5&externalPlugins=");
			t8 = space();
			li3 = element("li");
			p2 = element("p");
			a4 = element("a");
			t9 = text("https://v8.dev/features/string-matchall");
			t10 = space();
			li6 = element("li");
			p3 = element("p");
			t11 = text("the proposal spec");
			t12 = space();
			ul1 = element("ul");
			li4 = element("li");
			a5 = element("a");
			t13 = text("https://github.com/tc39/proposal-string-matchall");
			t14 = space();
			li5 = element("li");
			a6 = element("a");
			t15 = text("https://github.com/tc39/proposal-string-matchall/blob/master/spec.md#stringprototypematchall--regexp-");
			t16 = space();
			li7 = element("li");
			p4 = element("p");
			a7 = element("a");
			t17 = text("https://tc39.es/ecma262/#sec-regexpcreate");
			t18 = space();
			li8 = element("li");
			p5 = element("p");
			a8 = element("a");
			t19 = text("https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/matchAll");
			this.h();
		},
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "String.matchAll bug in Babel");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			a1 = claim_element(h2_nodes, "A", { href: true, id: true });
			var a1_nodes = children(a1);
			t2 = claim_text(a1_nodes, "String.matchAll bug in Babel");
			a1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t4 = claim_text(a2_nodes, "https://github.com/babel/babel/issues/10134");
			a2_nodes.forEach(detach);
			...
			t6 = claim_text(p1_nodes, "repl: ");
			a3 = claim_element(p1_nodes, "A", { href: true, rel: true });
			var a3_nodes = children(a3);
			t7 = claim_text(a3_nodes, "https://babeljs.io/en/repl#?babili=false&browsers=&build=&builtIns=false&spec=false&loose=false&code_lz=MYewdgzgLgBNBOBLMBzGBeGByAYgQwDcQkoBTGAcUSgAkBXAIxnlIAcQIAuGKYAZgCcAelLAAtngBMANkkwCADiGKAdABNSBLAG4AUKEiwWKUgA8MMIQB0GACgD8AHhAB3MKXgA-ANp4AtABeAAx-AgC6ANQAlFZCDo4s7D7-waFWKpExDEIoeroAZsQwtgbQMBK8ABYwIPlwUEioKhXAlQCCADYdtsZmUVEwAN66MDClIB2kKh0gKLYABgAkgy2V3kFhAL4weLDLqyrIGqbbLtTVWPu7rYdgrHRQm1jzUXqj45PTswuASYQ1bh5uFcqioUPAQHRWBAVK53PBNi83mNwBAJlMZnN5n9EiAgStrpVQeDIdCcQjXrpNkA&debug=true&forceAllTransforms=false&shippedProposals=false&circleciRepo=&evaluate=false&fileSize=false&timeTravel=false&sourceType=module&lineWrap=false&presets=env&prettier=false&targets=Node-9&version=7.4.5&externalPlugins=");
			a3_nodes.forEach(detach);
			...
			var a4_nodes = children(a4);
			t9 = claim_text(a4_nodes, "https://v8.dev/features/string-matchall");
			a4_nodes.forEach(detach);
			...
			var li6_nodes = children(li6);
			p3 = claim_element(li6_nodes, "P", {});
			var p3_nodes = children(p3);
			t11 = claim_text(p3_nodes, "the proposal spec");
			...
			var li4_nodes = children(li4);
			a5 = claim_element(li4_nodes, "A", { href: true, rel: true });
			var a5_nodes = children(a5);
			t13 = claim_text(a5_nodes, "https://github.com/tc39/proposal-string-matchall");
			a5_nodes.forEach(detach);
			li4_nodes.forEach(detach);
			...
			var a6_nodes = children(a6);
			t15 = claim_text(a6_nodes, "https://github.com/tc39/proposal-string-matchall/blob/master/spec.md#stringprototypematchall--regexp-");
			a6_nodes.forEach(detach);
			li5_nodes.forEach(detach);
			...
			var li7_nodes = children(li7);
			p4 = claim_element(li7_nodes, "P", {});
			var p4_nodes = children(p4);
			a7 = claim_element(p4_nodes, "A", { href: true, rel: true });
			var a7_nodes = children(a7);
			t17 = claim_text(a7_nodes, "https://tc39.es/ecma262/#sec-regexpcreate");
			a7_nodes.forEach(detach);
			...
			var a8_nodes = children(a8);
			t19 = claim_text(a8_nodes, "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/matchAll");
			a8_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "#string-matchall-bug-in-babel");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a1, "href", "#string-matchall-bug-in-babel");
			attr(a1, "id", "string-matchall-bug-in-babel");
			attr(a2, "href", "https://github.com/babel/babel/issues/10134");
			attr(a2, "rel", "nofollow");
			attr(a3, "href", "https://babeljs.io/en/repl#?babili=false&browsers=&build=&builtIns=false&spec=false&loose=false&code_lz=MYewdgzgLgBNBOBLMBzGBeGByAYgQwDcQkoBTGAcUSgAkBXAIxnlIAcQIAuGKYAZgCcAelLAAtngBMANkkwCADiGKAdABNSBLAG4AUKEiwWKUgA8MMIQB0GACgD8AHhAB3MKXgA-ANp4AtABeAAx-AgC6ANQAlFZCDo4s7D7-waFWKpExDEIoeroAZsQwtgbQMBK8ABYwIPlwUEioKhXAlQCCADYdtsZmUVEwAN66MDClIB2kKh0gKLYABgAkgy2V3kFhAL4weLDLqyrIGqbbLtTVWPu7rYdgrHRQm1jzUXqj45PTswuASYQ1bh5uFcqioUPAQHRWBAVK53PBNi83mNwBAJlMZnN5n9EiAgStrpVQeDIdCcQjXrpNkA&debug=true&forceAllTransforms=false&shippedProposals=false&circleciRepo=&evaluate=false&fileSize=false&timeTravel=false&sourceType=module&lineWrap=false&presets=env&prettier=false&targets=Node-9&version=7.4.5&externalPlugins=");
			attr(a3, "rel", "nofollow");
			attr(a4, "href", "https://v8.dev/features/string-matchall");
			attr(a4, "rel", "nofollow");
			attr(a5, "href", "https://github.com/tc39/proposal-string-matchall");
			attr(a5, "rel", "nofollow");
			attr(a6, "href", "https://github.com/tc39/proposal-string-matchall/blob/master/spec.md#stringprototypematchall--regexp-");
			attr(a6, "rel", "nofollow");
			attr(a7, "href", "https://tc39.es/ecma262/#sec-regexpcreate");
			attr(a7, "rel", "nofollow");
			attr(a8, "href", "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/matchAll");
