...
var __build_img_webp__2 = "e9fa1e4b9193f18d.webp";

var __build_img__2 = "e9fa1e4b9193f18d.png";

var __build_img_webp__1 = "52616dcad1ce28c5.webp";

var __build_img__1 = "52616dcad1ce28c5.png";

var __build_img_webp__0 = "63875c2221a8d717.webp";

var __build_img__0 = "63875c2221a8d717.png";
...
var baseCss = "https://lihautan.com/notes/css-podcast-019-z-index/assets/blog-base-248115e4.css";
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(meta8, "content", "https%3A%2F%2Flihautan.com%2Fnotes%2Fcss-podcast-019-z-index");
			attr(a, "href", "#content");
...
function create_default_slot(ctx) {
	...
	let raw0_value = `<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>parent<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token comment">&lt;!-- child hidden behind parent --></span>
...
<span class="token comment">&lt;!-- child still visible, can't hide behind html body --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>child<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
  ...
  <span class="token punctuation">&#125;</span>
	...
	let raw1_value = `<code class="language-css"><span class="token selector">:root</span> <span class="token punctuation">&#123;</span>
  <span class="token property">--dialog-z-index</span><span class="token punctuation">:</span> 1<span class="token punctuation">;</span>
  <span class="token property">--popup-z-index</span><span class="token punctuation">:</span> 2<span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>

<span class="token selector">.my-popup</span> <span class="token punctuation">&#123;</span>
  <span class="token property">z-index</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--popup-z-index<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>

<span class="token selector">.my-dialog</span> <span class="token punctuation">&#123;</span>
  <span class="token property">z-index</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--dialog-z-index<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>` + "";
	...
	let raw2_value = `<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>parent<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token comment">&lt;!-- z-index: 99 --></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>child1<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token comment">&lt;!-- z-index: 2 --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>child2<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
  ...
  <span class="token punctuation">&#125;</span>
  <span class="token selector">.parent</span> <span class="token punctuation">&#123;</span>
    <span class="token comment">/* any of the following will create a new stacking context, */</span>
    <span class="token comment">/* thus child2 will be on top of child1 */</span>

    <span class="token comment">/* 1) position + z-index not auto */</span>
    ...
    <span class="token property">filter</span><span class="token punctuation">:</span> <span class="token function">grayscale</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

    <span class="token comment">/* 3) opacity &lt; 1 */</span>
    <span class="token property">opacity</span><span class="token punctuation">:</span> 0.9999999<span class="token punctuation">;</span>

    <span class="token comment">/* 4) transform */</span>
    <span class="token property">transform</span><span class="token punctuation">:</span> <span class="token function">scale</span><span class="token punctuation">(</span>1<span class="token punctuation">)</span><span class="token punctuation">;</span>

    <span class="token comment">/* 5) will change: transform, opacity, filter, z-index */</span>
  ...
  <span class="token punctuation">&#125;</span>
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("1️⃣ Natural stacking order");
			li1 = element("li");
			a1 = element("a");
			t1 = text("2️⃣ z-index");
			li2 = element("li");
			a2 = element("a");
			t2 = text("3️⃣ negative z-index");
			li3 = element("li");
			a3 = element("a");
			t3 = text("4️⃣ Highest z-index value");
			li4 = element("li");
			a4 = element("a");
			t4 = text("5️⃣ Debugging z-index");
			li5 = element("li");
			a5 = element("a");
			t5 = text("6️⃣ Manage z-index");
			li6 = element("li");
			a6 = element("a");
			t6 = text("7️⃣ stacking context");
			li7 = element("li");
			a7 = element("a");
			t7 = text("Links");
			t8 = space();
			...
			h20 = element("h2");
			a8 = element("a");
			t9 = text("1️⃣ Natural stacking order");
			t10 = space();
			ul1 = element("ul");
			li8 = element("li");
			t11 = text("Order of the element in the DOM.");
			t12 = space();
			li9 = element("li");
			t13 = text("Last child in DOM tree appears in the frontmost");
			t14 = space();
			li10 = element("li");
			t15 = text("CSS grid when assigning multiple elements into the same grid, without z-index, the order of stacking of the elements depends on their order in the DOM");
			t16 = space();
			li11 = element("li");
			code0 = element("code");
			t17 = text("flex-direction: reverse");
			t18 = text(" does not change the stacking order");
			t19 = space();
			section2 = element("section");
			h21 = element("h2");
			a9 = element("a");
			t20 = text("2️⃣ z-index");
			t21 = space();
			ul3 = element("ul");
			li12 = element("li");
			t22 = text("can be positive / negative");
			t23 = space();
			li14 = element("li");
			t24 = text("need to set position other than static, in order to work");
			ul2 = element("ul");
			li13 = element("li");
			t25 = text("need a position to make z-index to have context");
			t26 = space();
			li15 = element("li");
			t27 = text("why z-index not working, position");
			t28 = space();
			section3 = element("section");
			h22 = element("h2");
			a10 = element("a");
			t29 = text("3️⃣ negative z-index");
			t30 = space();
			ul4 = element("ul");
			li16 = element("li");
			t31 = text("negative z-index goes behind the parent.");
			t32 = space();
			li17 = element("li");
			t33 = text("html tag has base z-index, you can't go behind the ");
			code1 = element("code");
			t34 = text("<html>");
			t35 = space();
			pre0 = element("pre");
			...
			h23 = element("h2");
			a12 = element("a");
			t39 = text("4️⃣ Highest z-index value");
			t40 = space();
			ul5 = element("ul");
			li18 = element("li");
			t41 = text("Not mentioned in the spec, limited by the implementation (32-bit signed integer)");
			t42 = space();
			li19 = element("li");
			t43 = text("(2^31)-1");
			t44 = space();
			...
			h24 = element("h2");
			a13 = element("a");
			t45 = text("5️⃣ Debugging z-index");
			t46 = space();
			ul6 = element("ul");
			li20 = element("li");
			p1 = element("p");
			t47 = text("Layers panel");
			t48 = space();
			p2 = element("p");
			...
			li22 = element("li");
			p5 = element("p");
			t53 = text("visbug /pesticide plugin");
			t54 = space();
			p6 = element("p");
			...
			p7 = element("p");
			a14 = element("a");
			t56 = text("visbug extension");
			t57 = space();
			section6 = element("section");
			h25 = element("h2");
			a15 = element("a");
			t58 = text("6️⃣ Manage z-index");
			t59 = space();
			ul7 = element("ul");
			li23 = element("li");
			t60 = text("using css custom properties");
			t61 = space();
			li24 = element("li");
			t62 = text("name your z-index");
			t63 = space();
			pre1 = element("pre");
			t64 = space();
			...
			h26 = element("h2");
			a16 = element("a");
			t65 = text("7️⃣ stacking context");
			t66 = space();
			ul9 = element("ul");
			li25 = element("li");
			t67 = text("html create the 1st stacking context");
			t68 = space();
			li28 = element("li");
			t69 = text("To create stacking context");
			ul8 = element("ul");
			li26 = element("li");
			t70 = text("position + z-index not auto");
			t71 = space();
			li27 = element("li");
			t72 = text("when creating composite layer - filters, opacity, transform, will-change");
			t73 = space();
			pre2 = element("pre");
			t74 = space();
			p8 = element("p");
			...
			li29 = element("li");
			a19 = element("a");
			t79 = text("The CSS Podcast: 019: Z-Index and Stacking Context");
			t80 = space();
			li30 = element("li");
			a20 = element("a");
			t81 = text("Philip Walton: What no one told you about z-index");
			t82 = text(" (");
			a21 = element("a");
			t83 = text("My Note");
			t84 = text(")");
		...
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "1️⃣ Natural stacking order");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "2️⃣ z-index");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			...
			var a2_nodes = children(a2);
			t2 = claim_text(a2_nodes, "3️⃣ negative z-index");
			a2_nodes.forEach(detach);
			li2_nodes.forEach(detach);
			...
			var a3_nodes = children(a3);
			t3 = claim_text(a3_nodes, "4️⃣ Highest z-index value");
			a3_nodes.forEach(detach);
			li3_nodes.forEach(detach);
			...
			var a4_nodes = children(a4);
			t4 = claim_text(a4_nodes, "5️⃣ Debugging z-index");
			a4_nodes.forEach(detach);
			li4_nodes.forEach(detach);
			...
			var a5_nodes = children(a5);
			t5 = claim_text(a5_nodes, "6️⃣ Manage z-index");
			a5_nodes.forEach(detach);
			li5_nodes.forEach(detach);
			...
			var a6_nodes = children(a6);
			t6 = claim_text(a6_nodes, "7️⃣ stacking context");
			a6_nodes.forEach(detach);
			li6_nodes.forEach(detach);
			...
			var a8_nodes = children(a8);
			t9 = claim_text(a8_nodes, "1️⃣ Natural stacking order");
			a8_nodes.forEach(detach);
			...
			t11 = claim_text(li8_nodes, "Order of the element in the DOM.");
			li8_nodes.forEach(detach);
			t12 = claim_space(ul1_nodes);
			li9 = claim_element(ul1_nodes, "LI", {});
			var li9_nodes = children(li9);
			t13 = claim_text(li9_nodes, "Last child in DOM tree appears in the frontmost");
			li9_nodes.forEach(detach);
			t14 = claim_space(ul1_nodes);
			li10 = claim_element(ul1_nodes, "LI", {});
			var li10_nodes = children(li10);
			t15 = claim_text(li10_nodes, "CSS grid when assigning multiple elements into the same grid, without z-index, the order of stacking of the elements depends on their order in the DOM");
			...
			t17 = claim_text(code0_nodes, "flex-direction: reverse");
			code0_nodes.forEach(detach);
			t18 = claim_text(li11_nodes, " does not change the stacking order");
			...
			t20 = claim_text(a9_nodes, "2️⃣ z-index");
			...
			t22 = claim_text(li12_nodes, "can be positive / negative");
			li12_nodes.forEach(detach);
			t23 = claim_space(ul3_nodes);
			li14 = claim_element(ul3_nodes, "LI", {});
			var li14_nodes = children(li14);
			t24 = claim_text(li14_nodes, "need to set position other than static, in order to work");
			ul2 = claim_element(li14_nodes, "UL", {});
			var ul2_nodes = children(ul2);
			li13 = claim_element(ul2_nodes, "LI", {});
			var li13_nodes = children(li13);
			t25 = claim_text(li13_nodes, "need a position to make z-index to have context");
			...
			t27 = claim_text(li15_nodes, "why z-index not working, position");
			...
			t29 = claim_text(a10_nodes, "3️⃣ negative z-index");
			...
			t31 = claim_text(li16_nodes, "negative z-index goes behind the parent.");
			li16_nodes.forEach(detach);
			t32 = claim_space(ul4_nodes);
			li17 = claim_element(ul4_nodes, "LI", {});
			var li17_nodes = children(li17);
			t33 = claim_text(li17_nodes, "html tag has base z-index, you can't go behind the ");
			code1 = claim_element(li17_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t34 = claim_text(code1_nodes, "<html>");
			...
			p0 = claim_element(section3_nodes, "P", {});
			var p0_nodes = children(p0);
			a11 = claim_element(p0_nodes, "A", { href: true, rel: true });
			var a11_nodes = children(a11);
			t37 = claim_text(a11_nodes, "Codepen");
			...
			t39 = claim_text(a12_nodes, "4️⃣ Highest z-index value");
			...
			t41 = claim_text(li18_nodes, "Not mentioned in the spec, limited by the implementation (32-bit signed integer)");
			li18_nodes.forEach(detach);
			t42 = claim_space(ul5_nodes);
			li19 = claim_element(ul5_nodes, "LI", {});
			var li19_nodes = children(li19);
			t43 = claim_text(li19_nodes, "(2^31)-1");
			...
			t45 = claim_text(a13_nodes, "5️⃣ Debugging z-index");
			a13_nodes.forEach(detach);
			h24_nodes.forEach(detach);
			t46 = claim_space(section5_nodes);
			ul6 = claim_element(section5_nodes, "UL", {});
			var ul6_nodes = children(ul6);
			li20 = claim_element(ul6_nodes, "LI", {});
			var li20_nodes = children(li20);
			p1 = claim_element(li20_nodes, "P", {});
			var p1_nodes = children(p1);
			t47 = claim_text(p1_nodes, "Layers panel");
			p1_nodes.forEach(detach);
			t48 = claim_space(li20_nodes);
			p2 = claim_element(li20_nodes, "P", {});
			...
			t49 = claim_space(ul6_nodes);
			li21 = claim_element(ul6_nodes, "LI", {});
			var li21_nodes = children(li21);
			p3 = claim_element(li21_nodes, "P", {});
			var p3_nodes = children(p3);
			t50 = claim_text(p3_nodes, "visbug /zindex plugin");
			p3_nodes.forEach(detach);
			t51 = claim_space(li21_nodes);
			p4 = claim_element(li21_nodes, "P", {});
			...
			p5 = claim_element(li22_nodes, "P", {});
			var p5_nodes = children(p5);
			t53 = claim_text(p5_nodes, "visbug /pesticide plugin");
			p5_nodes.forEach(detach);
			t54 = claim_space(li22_nodes);
			p6 = claim_element(li22_nodes, "P", {});
			...
			a14 = claim_element(p7_nodes, "A", { href: true, rel: true });
			var a14_nodes = children(a14);
			t56 = claim_text(a14_nodes, "visbug extension");
			...
			a15 = claim_element(h25_nodes, "A", { href: true, id: true });
			var a15_nodes = children(a15);
			t58 = claim_text(a15_nodes, "6️⃣ Manage z-index");
			...
			t60 = claim_text(li23_nodes, "using css custom properties");
			li23_nodes.forEach(detach);
			t61 = claim_space(ul7_nodes);
			li24 = claim_element(ul7_nodes, "LI", {});
			var li24_nodes = children(li24);
			t62 = claim_text(li24_nodes, "name your z-index");
			...
			t65 = claim_text(a16_nodes, "7️⃣ stacking context");
			...
			a18 = claim_element(h27_nodes, "A", { href: true, id: true });
			var a18_nodes = children(a18);
			t77 = claim_text(a18_nodes, "Links");
			...
			a19 = claim_element(li29_nodes, "A", { href: true, rel: true });
			var a19_nodes = children(a19);
			t79 = claim_text(a19_nodes, "The CSS Podcast: 019: Z-Index and Stacking Context");
			a19_nodes.forEach(detach);
			li29_nodes.forEach(detach);
			t80 = claim_space(ul10_nodes);
			li30 = claim_element(ul10_nodes, "LI", {});
			var li30_nodes = children(li30);
			a20 = claim_element(li30_nodes, "A", { href: true, rel: true });
			var a20_nodes = children(a20);
			t81 = claim_text(a20_nodes, "Philip Walton: What no one told you about z-index");
			a20_nodes.forEach(detach);
			t82 = claim_text(li30_nodes, " (");
			a21 = claim_element(li30_nodes, "A", { href: true });
			var a21_nodes = children(a21);
			t83 = claim_text(a21_nodes, "My Note");
			a21_nodes.forEach(detach);
			t84 = claim_text(li30_nodes, ")");
		...
		h() {
			attr(a0, "href", "#natural-stacking-order");
			attr(a1, "href", "#z-index");
			attr(a2, "href", "#negative-z-index");
			attr(a3, "href", "#highest-z-index-value");
			attr(a4, "href", "#debugging-z-index");
			attr(a5, "href", "#manage-z-index");
			attr(a6, "href", "#stacking-context");
			attr(a7, "href", "#links");
			attr(ul0, "class", "sitemap");
			attr(ul0, "id", "sitemap");
			attr(ul0, "role", "navigation");
			attr(ul0, "aria-label", "Table of Contents");
			attr(a8, "href", "#natural-stacking-order");
			attr(a8, "id", "natural-stacking-order");
			attr(a9, "href", "#z-index");
			attr(a9, "id", "z-index");
			attr(a10, "href", "#negative-z-index");
			attr(a10, "id", "negative-z-index");
			attr(pre0, "class", "language-html");
			attr(a11, "href", "https://codepen.io/tanhauhau/pen/WNwvraL");
			attr(a11, "rel", "nofollow");
			attr(a12, "href", "#highest-z-index-value");
			attr(a12, "id", "highest-z-index-value");
			attr(a13, "href", "#debugging-z-index");
			attr(a13, "id", "debugging-z-index");
			...
			attr(a14, "href", "https://chrome.google.com/webstore/detail/visbug/cdockenadnadldjbbgcallicgledbeoc?hl=en");
			attr(a14, "rel", "nofollow");
			attr(a15, "href", "#manage-z-index");
			attr(a15, "id", "manage-z-index");
			attr(pre1, "class", "language-css");
			attr(a16, "href", "#stacking-context");
			attr(a16, "id", "stacking-context");
			attr(pre2, "class", "language-html");
			attr(a17, "href", "https://codepen.io/tanhauhau/pen/NWNqxEe");
			attr(a17, "rel", "nofollow");
			attr(a18, "href", "#links");
			attr(a18, "id", "links");
			attr(a19, "href", "https://podcasts.google.com/feed/aHR0cHM6Ly90aGVjc3Nwb2RjYXN0LmxpYnN5bi5jb20vcnNz/episode/NmZmNzlmOTgtNmM2NS00MjVhLWE0M2UtNTY1YmY4MjYxODU5?sa=X&ved=2ahUKEwiH-uH7_YzrAhWlGbcAHWJKBHcQkfYCegQIARAF");
			attr(a19, "rel", "nofollow");
			attr(a20, "href", "https://philipwalton.com/articles/what-no-one-told-you-about-z-index/");
			attr(a20, "rel", "nofollow");
			attr(a21, "href", "./what-no-one-told-you-about-z-index");
		},
		m(target, anchor) {
...
const metadata = {
	...
	"tags": ["z-index", "stacking context", "The CSS Podcast"],
	"slug": "notes/css-podcast-019-z-index",
	"type": "notes",
	"name": "css-podcast-019-z-index",
	"layout": "note"
};
