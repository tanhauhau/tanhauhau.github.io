...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "https%3A%2F%2Flihautan.com%2Fusing-variables-in-style-tag-in-svelte",
					"name": /*title*/ ctx[0]
				},
				"name": /*title*/ ctx[0],
				"position": 2
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "https%3A%2F%2Flihautan.com%2Fusing-variables-in-style-tag-in-svelte");
...
/* content/blog/using-variables-in-style-tag-in-svelte/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			p = element("p");
			t = text("Let's say I have a");
		},
		l(nodes) {
			p = claim_element(nodes, "P", {});
			var p_nodes = children(p);
			t = claim_text(p_nodes, "Let's say I have a");
			p_nodes.forEach(detach);
		},
		m(target, anchor) {
...
const metadata = {
	...
	"tags": ["svelte", "style", "variables"],
	"wip": true,
	"slug": "using-variables-in-style-tag-in-svelte",
	"type": "blog"
};
