...
var image = "https://lihautan.com/compile-svelte-in-your-head-part-5/assets/hero-twitter-cf288ab2.jpg";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "https%3A%2F%2Flihautan.com%2Fcompile-svelte-in-your-head-part-5",
					"name": /*title*/ ctx[0]
				},
				"name": /*title*/ ctx[0],
				"position": 2
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "https%3A%2F%2Flihautan.com%2Fcompile-svelte-in-your-head-part-5");
...
/* content/blog/compile-svelte-in-your-head-part-5/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			li0 = element("li");
			a0 = element("a");
			t0 = text("The  {#each}  block");
			li1 = element("li");
			a1 = element("a");
			t1 = text("Closing Note");
			t2 = space();
			p0 = element("p");
			strong0 = element("strong");
			t3 = text("⬅ ⬅ Previously in ");
			a2 = element("a");
			t4 = text("Part 4");
			t5 = text(".");
			t6 = space();
			p1 = element("p");
			t7 = text("In this article, we are going to cover the 2nd logic block, the ");
			strong1 = element("strong");
			t8 = text("each block");
			t9 = text(".");
			t10 = space();
			p2 = element("p");
			t11 = text("To make sure we are on the same page, let's first explain how ");
			code0 = element("code");
			t12 = text("{#each}");
			t13 = text(" block works.");
			t14 = space();
			...
			code2 = element("code");
			t19 = text("{#each}");
			t20 = text(" block allow us to loop");
			t21 = space();
			section2 = element("section");
			h21 = element("h2");
			a4 = element("a");
			t22 = text("Closing Note");
			t23 = space();
			p4 = element("p");
			t24 = text("If you wish to learn more about Svelte, ");
			a5 = element("a");
			t25 = text("follow me on Twitter");
			t26 = text(".");
			t27 = space();
			p5 = element("p");
			t28 = text("I'll post it on Twitter when the next part is ready, the next post will be about ");
			code3 = element("code");
			t29 = text("bind:group");
			t30 = text(".");
			this.h();
		...
		l(nodes) {
			...
			var a0_nodes = children(a0);
			t0 = claim_text(a0_nodes, "The  {#each}  block");
			a0_nodes.forEach(detach);
			li0_nodes.forEach(detach);
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Closing Note");
			a1_nodes.forEach(detach);
			li1_nodes.forEach(detach);
			ul_nodes.forEach(detach);
			...
			t3 = claim_text(strong0_nodes, "⬅ ⬅ Previously in ");
			a2 = claim_element(strong0_nodes, "A", { href: true });
			var a2_nodes = children(a2);
			t4 = claim_text(a2_nodes, "Part 4");
			a2_nodes.forEach(detach);
			...
			t7 = claim_text(p1_nodes, "In this article, we are going to cover the 2nd logic block, the ");
			strong1 = claim_element(p1_nodes, "STRONG", {});
			var strong1_nodes = children(strong1);
			t8 = claim_text(strong1_nodes, "each block");
			...
			t11 = claim_text(p2_nodes, "To make sure we are on the same page, let's first explain how ");
			code0 = claim_element(p2_nodes, "CODE", {});
			var code0_nodes = children(code0);
			t12 = claim_text(code0_nodes, "{#each}");
			code0_nodes.forEach(detach);
			t13 = claim_text(p2_nodes, " block works.");
			...
			var a3_nodes = children(a3);
			t15 = claim_text(a3_nodes, "The ");
			code1 = claim_element(a3_nodes, "CODE", {});
			var code1_nodes = children(code1);
			t16 = claim_text(code1_nodes, "{#each}");
			code1_nodes.forEach(detach);
			t17 = claim_text(a3_nodes, " block");
			a3_nodes.forEach(detach);
			...
			t19 = claim_text(code2_nodes, "{#each}");
			code2_nodes.forEach(detach);
			t20 = claim_text(p3_nodes, " block allow us to loop");
			...
			var a4_nodes = children(a4);
			t22 = claim_text(a4_nodes, "Closing Note");
			a4_nodes.forEach(detach);
			h21_nodes.forEach(detach);
			t23 = claim_space(section2_nodes);
			p4 = claim_element(section2_nodes, "P", {});
			var p4_nodes = children(p4);
			t24 = claim_text(p4_nodes, "If you wish to learn more about Svelte, ");
			a5 = claim_element(p4_nodes, "A", { href: true, rel: true });
			var a5_nodes = children(a5);
			t25 = claim_text(a5_nodes, "follow me on Twitter");
			a5_nodes.forEach(detach);
			...
			t28 = claim_text(p5_nodes, "I'll post it on Twitter when the next part is ready, the next post will be about ");
			code3 = claim_element(p5_nodes, "CODE", {});
			var code3_nodes = children(code3);
			t29 = claim_text(code3_nodes, "bind:group");
		...
		h() {
			attr(a0, "href", "#the-each-block");
			attr(a1, "href", "#closing-note");
			attr(ul, "class", "sitemap");
			attr(ul, "id", "sitemap");
			attr(ul, "role", "navigation");
			attr(ul, "aria-label", "Table of Contents");
			attr(a2, "href", "/compile-svelte-in-your-head-part-4/");
			attr(a3, "href", "#the-each-block");
			attr(a3, "id", "the-each-block");
			attr(a4, "href", "#closing-note");
			attr(a4, "id", "closing-note");
...
const metadata = {
	...
	"wip": true,
	"slug": "compile-svelte-in-your-head-part-5",
	"type": "blog"
};
