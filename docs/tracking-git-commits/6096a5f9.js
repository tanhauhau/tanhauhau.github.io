...
var baseCss = "http://127.0.0.1:8080/tracking-git-commits/assets/_blog-299aa480.css";
...
function create_fragment$2(ctx) {
	...
	let raw1_value = `<script type="application/ld+json">${JSON.stringify({
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"item": {
					"@id": "http%3A%2F%2F127.0.0.1%3A8080%2Ftracking-git-commits",
					"name": /*title*/ ctx[0]
				},
				"position": 2
			}
	...
	return {
		...
		h() {
			...
			attr(meta11, "content", "http%3A%2F%2F127.0.0.1%3A8080%2Ftracking-git-commits");
...
/* content/blog/tracking-git-commits/@@page-markup.svelte generated by Svelte v3.24.0 */
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			p = element("p");
			t = text("find the origin of a change");
		},
		l(nodes) {
			p = claim_element(nodes, "P", {});
			var p_nodes = children(p);
			t = claim_text(p_nodes, "find the origin of a change");
			p_nodes.forEach(detach);
		},
		m(target, anchor) {
